...
::twoslash-code
---
path: packages/examples/src/drizzle/drizzle-keys-example.ts
---
::
...
Any columns asn SQL logic, like primary key, foreign keys, indexes, etc. should be defined in the tableConfig override.
::
...
<!-- code-import-timestamp 1770411522377 -->
