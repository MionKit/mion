...
When using branded format types (like `Email`, `Url`, `Number`, etc.), the error parameter types are **automatically inferred**. This means you get proper intellisense for the format parameters that might have failed without needing to manually specify the type.
...
| Type | Use For |
|------|---------|
| `StringErrorParams` | `String` |
| `EmailErrorParams` | `Email` | 
| `UrlErrorParams` | `Url` | 
| `DomainErrorParams` | `Domain` | 
| `IPErrorParams` | `IP` |
| `UUIDErrorParams` | `UUIDv4` | 
| `DateTimeErrorParams` | `StringDateTime` | 
| `DateErrorParams` | `StringDate` | 
| `TimeErrorParams` | `StringTime` | 
| `NumberErrorParams` | `Number` | 
| `BigIntErrorParams` | `BigInt` | 
