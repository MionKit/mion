...
- On the **server** build, set `serverMappers.consume` to that same path — the mappers are inlined into the server bundle and registered through the side-effect module `virtual:mion/server-mappers`.
