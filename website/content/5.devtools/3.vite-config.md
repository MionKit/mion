...
The `mionPlugin` from `@mionkit/devtools/vite-plugin` is the single Vite plugin that handles all mion build-time features: runtime type reflection, pure function extraction, and AOT cache generation.
