...
The `@mionkit/pure-functions` ESLint rule validates purity at lint time, catching violations before they reach the build step. See the [ESLint Rules](./eslint-rules) page for details.
