...
<code-import path="packages/examples/src/router/context-sharing.ts" lang="ts" />
...
<code-import path="packages/examples/src/router/context-factory.ts" lang="ts" commentStart="// start-interface" commentEnd="// end-interface" />

#### Initializing router with a context data factory

<code-import path="packages/examples/src/router/context-factory.ts" lang="ts" commentStart="// start-init" commentEnd="// end-init" />

#### Using typed context data in routes and hooks

<code-import path="packages/examples/src/router/context-factory.ts" lang="ts" commentStart="// start-usage" commentEnd="// end-usage" />
