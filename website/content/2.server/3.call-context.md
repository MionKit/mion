...
<code-import ts="0" path="packages/router/examples/context-sharing.ts" lang="ts" />
...
<code-import ts="0" path="packages/router/examples/context-factory.ts" lang="ts" commentStart="// start-interface" commentEnd="// end-interface" />

#### Initializing router with a context data factory

<code-import ts="0" path="packages/router/examples/context-factory.ts" lang="ts" commentStart="// start-init" commentEnd="// end-init" />

#### Using typed context data in routes and hooks

<code-import ts="0" path="packages/router/examples/context-factory.ts" lang="ts" commentStart="// start-usage" commentEnd="// end-usage" />
...
<code-import ts="0" path="packages/router/examples/types/call-context.ts" lang="ts" />
