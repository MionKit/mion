...
- ✅ **LinkedFns (middleware)**: Execute code before/after routes for auth, logging, etc.
...
- ✅ **Validation**: All route/linkedFn parameters are validated before execution
...
::card-group
  ...
  to: /server/linkedFns
  ---
  Auxiliary or (middleware) functions that get executed before or after a route. LinkedFns can send/receive data but cannot be called directly.
  :::
