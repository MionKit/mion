...
::card-group
  ...
  to: /server/execution-path
  ---
  Ordered list of all the methods to be executed when calling a route. Each execution path can contain multiple LinkedFns but a single Route method.
  :::
