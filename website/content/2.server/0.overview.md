...
const routes = {
    createUser: route((ctx, req: NewUser): User => {
        // req is already validated and types are restored
        console.log(req.birthDate instanceof Date); // true
        console.log(req.tags instanceof Set); // true
