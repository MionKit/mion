...
Same as routes the first parameter is always the [Call Context](/docs/server/call-context), the rest of parameters are remote parameters that get deserialized and validated before the hook gets executed.
