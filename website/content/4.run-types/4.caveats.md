...
This Rule will only check Types that are used in routes/useFns.
::
...
RunTypes needs explicit type annotations on route/useFn parameters and return types. Without them, TypeScript cannot emit the type metadata needed for runtime validation.
