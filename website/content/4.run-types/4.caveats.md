...
::note
Use the [`@mionkit/no-type-imports`](/devtools/eslint-rules#mionkitno-type-imports) ESLint rule to catch this issue.    
...
::note
Use the [`@mionkit/strong-typed-routes`](/devtools/eslint-rules#mionkitstrong-typed-routes) ESLint rule to catch this issue.
::
...
::note
Use the [`@mionkit/no-typeof-runtype`](/devtools/eslint-rules#mionkitno-typeof-runtype) ESLint rule to catch this issue.
::
...
::note
Use the [`@mionkit/no-unreachable-union-types`](/devtools/eslint-rules#mionkitno-unreachable-union-types) ESLint rule to catch this issue.   
This rule will only check Types that are used in routes/linkedFns.
::
