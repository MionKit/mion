...
<code-import ts="0" path="packages/run-types/examples/validation-is-type.ts" lang="ts" />

#### `createTypeErrorsFn<T>()`

Returns a function that returns detailed error information when validation fails.

<code-import ts="0" path="packages/run-types/examples/validation-type-errors.ts" lang="ts" />
...
<code-import ts="0" path="packages/run-types/examples/json-prepare.ts" lang="ts" />
...
<code-import ts="0" path="packages/run-types/examples/json-restore.ts" lang="ts" />

#### `createJsonStringifyFn<T>()`

Combines `prepareForJson` with `JSON.stringify` for optimal performance.

<code-import ts="0" path="packages/run-types/examples/json-stringify.ts" lang="ts" />
...
<code-import ts="0" path="packages/run-types/examples/binary-serialization.ts" lang="ts" commentStart="// start-to-binary" commentEnd="// end-to-binary" />

#### `createFromBinaryFn<T>()`

Deserializes a binary buffer back to the original type.

<code-import ts="0" path="packages/run-types/examples/binary-serialization.ts" lang="ts" commentStart="// start-from-binary" commentEnd="// end-from-binary" />
...
<code-import ts="0" path="packages/run-types/examples/mock-data.ts" lang="ts" commentStart="// start-basic" commentEnd="// end-basic" />

When using Type Formats, mock data respects format constraints:

<code-import ts="0" path="packages/run-types/examples/mock-data.ts" lang="ts" commentStart="// start-formats" commentEnd="// end-formats" />

---

## Complete Example

<code-import ts="0" path="packages/run-types/examples/complete-example.ts" lang="ts" />
...
<code-import ts="0" path="packages/run-types/examples/advanced-runtype.ts" lang="ts" commentStart="// start-runtype" commentEnd="// end-runtype" />

### `reflectFunction<Fn>()`

Reflects a function to get type information about its parameters and return type.

<code-import ts="0" path="packages/run-types/examples/advanced-runtype.ts" lang="ts" commentStart="// start-reflect-function" commentEnd="// end-reflect-function" />
...
<code-import ts="0" path="packages/run-types/examples/serialization-any.ts" lang="ts" />
...
<code-import ts="0" path="packages/run-types/examples/serialization-union.ts" lang="ts" />
