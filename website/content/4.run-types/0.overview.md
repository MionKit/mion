...
<code-import ts="1768770138105" path="packages/examples/src/run-types/validation-is-type.ts" lang="ts" />

#### `createTypeErrorsFn<T>()`

Returns a function that returns detailed error information when validation fails.

<code-import ts="1768770138136" path="packages/examples/src/run-types/validation-type-errors.ts" lang="ts" />
...
<code-import ts="1768770137858" path="packages/examples/src/run-types/json-prepare.ts" lang="ts" />
...
<code-import ts="1768770137890" path="packages/examples/src/run-types/json-restore.ts" lang="ts" />

#### `createJsonStringifyFn<T>()`

Combines `prepareForJson` with `JSON.stringify` for optimal performance.

<code-import ts="1768770137940" path="packages/examples/src/run-types/json-stringify.ts" lang="ts" />
...
<code-import ts="1768770137714" path="packages/examples/src/run-types/binary-serialization.ts" lang="ts" commentStart="// start-to-binary" commentEnd="// end-to-binary" />

#### `createFromBinaryFn<T>()`

Deserializes a binary buffer back to the original type.

<code-import ts="1768770137714" path="packages/examples/src/run-types/binary-serialization.ts" lang="ts" commentStart="// start-from-binary" commentEnd="// end-from-binary" />
...
<code-import ts="1768770137858" path="packages/examples/src/run-types/mock-data.ts" lang="ts" commentStart="// start-basic" commentEnd="// end-basic" />

When using Type Formats, mock data respects format constraints:

<code-import ts="1768770137858" path="packages/examples/src/run-types/mock-data.ts" lang="ts" commentStart="// start-formats" commentEnd="// end-formats" />

---

## Complete Example

<code-import ts="1768770137834" path="packages/examples/src/run-types/complete-example.ts" lang="ts" />
...
<code-import ts="1768770137691" path="packages/examples/src/run-types/advanced-runtype.ts" lang="ts" commentStart="// start-runtype" commentEnd="// end-runtype" />

### `reflectFunction<Fn>()`

Reflects a function to get type information about its parameters and return type.

<code-import ts="1768770137691" path="packages/examples/src/run-types/advanced-runtype.ts" lang="ts" commentStart="// start-reflect-function" commentEnd="// end-reflect-function" />
...
<code-import ts="1768770138030" path="packages/examples/src/run-types/serialization-any.ts" lang="ts" />
...
<code-import ts="1768770138067" path="packages/examples/src/run-types/serialization-union.ts" lang="ts" />
