...
<code-import path="packages/examples/src/type-formats/string-imports.ts" lang="ts" />

### Usage Examples

<code-import path="packages/examples/src/type-formats/string-usage.ts" lang="ts" />

### Custom String Formats with `StrFormat`

Use `StrFormat` to define custom string constraints:

<code-import path="packages/examples/src/type-formats/string-custom.ts" lang="ts" />
...
<code-import path="packages/examples/src/type-formats/number-imports.ts" lang="ts" />

### Usage Examples

<code-import path="packages/examples/src/type-formats/number-usage.ts" lang="ts" />

### Custom Number Formats with `NumFormat`

<code-import path="packages/examples/src/type-formats/number-custom.ts" lang="ts" />
...
<code-import path="packages/examples/src/type-formats/complete-example.ts" lang="ts" />

### Using with Validation

<code-import path="packages/examples/src/type-formats/validation-usage.ts" lang="ts" />
...
<code-import path="packages/examples/src/type-formats/binary-optimization.ts" lang="ts" />
