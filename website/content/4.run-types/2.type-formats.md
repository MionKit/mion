...
<code-import ts="0" path="packages/type-formats/examples/string-imports.ts" lang="ts" />

### Usage Examples

<code-import ts="0" path="packages/type-formats/examples/string-usage.ts" lang="ts" />

### Custom String Formats with `StrFormat`

Use `StrFormat` to define custom string constraints:

<code-import ts="0" path="packages/type-formats/examples/string-custom.ts" lang="ts" />
...
<code-import ts="0" path="packages/type-formats/examples/number-imports.ts" lang="ts" />

### Usage Examples

<code-import ts="0" path="packages/type-formats/examples/number-usage.ts" lang="ts" />

### Custom Number Formats with `NumFormat`

<code-import ts="0" path="packages/type-formats/examples/number-custom.ts" lang="ts" />
...
<code-import ts="0" path="packages/type-formats/examples/complete-example.ts" lang="ts" />

### Using with Validation

<code-import ts="0" path="packages/type-formats/examples/validation-usage.ts" lang="ts" />
...
<code-import ts="0" path="packages/type-formats/examples/binary-optimization.ts" lang="ts" />
