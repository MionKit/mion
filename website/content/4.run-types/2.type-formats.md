...
Import string formats from `@mionkit/type-formats/StringFormats`:
...
Import number formats from `@mionkit/type-formats/NumberFormats`:
...
```ts
import type {FormatEmail, FormatUUIDv4} from '@mionkit/type-formats/StringFormats';
...
```ts
import type {FormatString} from '@mionkit/type-formats/StringFormats';
import type {FormatNumber} from '@mionkit/type-formats/NumberFormats';
