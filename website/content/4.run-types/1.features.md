...
<code-import ts="1768770137999" path="packages/examples/src/run-types/reflect-function-note.ts" lang="ts" />
::
...
<code-import ts="1768770137762" path="packages/examples/src/run-types/comparison-schema-first.ts" lang="ts" />
...
<code-import ts="1768770137790" path="packages/examples/src/run-types/comparison-type-first.ts" lang="ts" />
...
<code-import ts="1768770137809" path="packages/examples/src/run-types/comparison-typia.ts" lang="ts" />

**mion example** (types extracted from functions and validated automatically):

<code-import ts="1768770137739" path="packages/examples/src/run-types/comparison-mion.ts" lang="ts" />
