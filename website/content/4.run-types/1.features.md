...
<code-import ts="0" path="packages/run-types/examples/reflect-function-note.ts" lang="ts" />
::
...
<code-import ts="0" path="packages/run-types/examples/comparison-schema-first.ts" lang="ts" />
...
<code-import ts="0" path="packages/run-types/examples/comparison-type-first.ts" lang="ts" />
...
<code-import ts="0" path="packages/run-types/examples/comparison-typia.ts" lang="ts" />

**mion example** (types extracted from functions and validated automatically):

<code-import ts="0" path="packages/run-types/examples/comparison-mion.ts" lang="ts" />
