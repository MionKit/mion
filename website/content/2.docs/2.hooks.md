...
As headers are always strings, when using a header hook [Soft Type Conversion](https://deepkit.io/documentation/serialization.html#serialisation-loosely-convertion){target="_blank"} is used, this means strings like '1' , '0', 'true', 'false'
