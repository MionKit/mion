...
<code-import ts="0" path="packages/examples/src/router/about-server.ts" lang="ts [server.ts]" />

<code-import ts="1768770126219" path="packages/examples/src/client/about-client.ts" lang="ts [client.ts]" />
