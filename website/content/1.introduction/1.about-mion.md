...
* mion takes advantage of a new generation of tools <sup>[(Deepkit)](../server/validation)</sup> that bring types to runtime allowing automatic validation/serialization out of the box and a whole new set of possibilities.
