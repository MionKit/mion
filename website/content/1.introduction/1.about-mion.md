...
<code-import ts="0" path="packages/router/examples/about-server.ts" lang="ts [server.ts]" />

<code-import ts="1768768801137" path="packages/client/examples/about-client.ts" lang="ts [client.ts]" />
