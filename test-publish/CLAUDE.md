...
- `scripts/rewrite-deps.js`: renames versioned tarballs to unversioned names (called automatically by pack-and-install)
...
- Must re-run `pack-and-install.sh` after any mion package changes to pick up updates
