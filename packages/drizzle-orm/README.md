...
Part of the mion framework, the sibling of the `RunTypes/*` packages. Full documentation lives at [mion.pages.dev](https://mion.pages.dev/) and [runtypes.pages.dev](https://runtypes.pages.dev/).
