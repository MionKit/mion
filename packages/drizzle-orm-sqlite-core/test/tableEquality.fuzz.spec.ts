...
// Property fuzz for the slim sqlite surface, oracle: compare-to-a-trusted-source.
...
// drizzle-orm/sqlite-core, and (for specs the pure-types vocabulary covers) the
