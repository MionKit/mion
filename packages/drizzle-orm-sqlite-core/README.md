...
🚀 Declare drizzle-orm/sqlite-core tables as usual and get **mion Type Formats** fidelity in the inferred models, plus type-level table refinement (refineTableType + InferSelect/InferInsert/InferUpdate). Versioned in lockstep with drizzle-orm minor lines.
