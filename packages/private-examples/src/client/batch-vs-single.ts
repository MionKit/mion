...
// returns [result, error, undeclared, middlewareResults, middlewareErrors]
...
// returns [[results...], [errors...], undeclared, middlewareResults, middlewareErrors]; one undeclared per batch
