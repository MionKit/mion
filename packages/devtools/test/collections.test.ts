...
describe('@mionjs/devtools / collection round-trip', () => {
  ...
  runTest(
    ...
    {
      'obj.ts': `import {getRunTypeId} from '@mionjs/run-types';
interface O {
  readonly id: number;
  nick?: string;
  "weird prop name \\n?>'\\\\\\t\\r": boolean;
...
`,
  ...
  runTest(
    ...
    {
      'cls.ts': `import {getRunTypeId} from '@mionjs/run-types';
class U {
  public id = 0;
  private secret = "";
  protected hint = 0;
...
`,
  ...
  runTest(
    ...
    {
      'tup.ts': `import {getRunTypeId} from '@mionjs/run-types';
...
`,
  ...
  runTest(
    ...
    {
      'idx.ts': `import {getRunTypeId} from '@mionjs/run-types';
interface M {
