...
import {applyEdits, sourceHash} from '../src/core/apply-edits.ts';
import type {SourceMap} from '../src/core/protocol.ts';
import {BARE_CWD, BIN, hasBinary, MARKER_PACKAGE_OVERLAY, runTest, withInlineSources} from './helpers/inline.ts';
import {MODULE_MODE_ALL_SINGLE} from '../src/core/go-generated/runtypes-constants.generated.ts';
...
describe('@mionjs/devtools / transform modes / parity', () => {
...
describe('@mionjs/devtools / transform modes / source-consistency guard', () => {
  runTest(
...
describe('@mionjs/devtools / transform modes / go-mode sourcesContent trim', () => {
  runTest(
