...
/** The shim's source file path suffix, used to verify alias-resolved paths point to the actual shim file. */
export const AOT_CACHES_SHIM_SOURCE = 'src/aot/emptyCaches.ts';
