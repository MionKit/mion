declare const plugin: {
    rules: {
        ...
        'no-vite-client': import('@typescript-eslint/utils/ts-eslint').RuleModule<"missingPureFnName" | "missingMapFromName" | "nameNotStringLiteral" | "registerPureFnFactoryNotAllowed", [], unknown, import('@typescript-eslint/utils/ts-eslint').RuleListener>;
