...
var rule = {
	...
	create(context) {
		...
		function fixImport(fixer, node) {
			...
			const fixes = [];
			for (const specifier of node.specifiers) if (specifier.type === AST_NODE_TYPES.ImportSpecifier && specifier.importKind !== "type") fixes.push(fixer.insertTextBefore(specifier, "type "));
			return fixes;
		}
...
//# sourceMappingURL=enforce-type-imports.js.map