// Copied from packages/ts-runtypes/test/support/temporal-ambient.d.ts for the drizzle
// test program: the specs reflect Temporal-formatted props into columns and the scanner
// needs the Temporal namespace declared (the repo lib predates Temporal). NOT published.
