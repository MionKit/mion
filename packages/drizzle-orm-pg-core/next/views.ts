...
import type {LiftNames, NoNames, RtViewMeta} from '../../drizzle-orm/next/table.ts';
import {pgBuildMaterializedView, pgBuildView} from '../src/views.ts';
import type {AnyColumnBuilder, LiftCols} from './table.ts';
...
export function pgView<TName extends string, Cols extends Record<string, AnyColumnBuilder>>(
  name: TName,
  columns: Cols
): PgViewBuilder<TName, LiftCols<Cols>, LiftNames<Cols>> {
...
export function pgMaterializedView<TName extends string, Cols extends Record<string, AnyColumnBuilder>>(
  name: TName,
  columns: Cols
): PgMaterializedViewBuilder<TName, LiftCols<Cols>, LiftNames<Cols>> {
