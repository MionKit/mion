...
// Runtime pins for the @mionjs/drizzle-orm-pg-core proxy builders: a table declared
...
import {integer, numeric, pgTable, text, timestamp, uuid, varchar} from './index.ts';
