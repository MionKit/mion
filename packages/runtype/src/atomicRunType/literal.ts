...
function compileTypeErrorsSymbol(cop: JitTypeErrorCompiler, lit: symbol, name: string | number): string {
...
function compileTypeErrorsRegExp(cop: JitTypeErrorCompiler, lit: RegExp, name: string | number): string {
