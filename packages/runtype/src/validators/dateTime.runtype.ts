...
import {DateStringParams} from './date.runtype';
import {TimeStringParams} from './time.runtype';

export type StringDateParams = {
    dateFormat: DateStringParams['format'];
    timeFormat: TimeStringParams['format'];
};

export const defaultDateParams = {
    dateFormat: 'ISO',
    timeFormat: 'ISO',
} as const satisfies StringDateParams;
