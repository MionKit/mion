...
export function mionIsTimeZone(jUtil: JITUtils) {
    const isH = jUtil.getPureFn('mionFormats', 'mionIsHours') as ReturnType<typeof mionIsHours>;
    const isM = jUtil.getPureFn('mionFormats', 'mionIsMinutes') as ReturnType<typeof mionIsMinutes>;
...
export function mionIsSecondsWithMs(jUtil: JITUtils) {
    const isS = jUtil.getPureFn('mionFormats', 'mionIsSeconds') as ReturnType<typeof mionIsSeconds>;
...
export function mionIsTimeString_ISO_TZ(jUtil: JITUtils) {
    const isTWms = jUtil.getPureFn('mionFormats', 'mionIsTimeString_ISO') as ReturnType<typeof mionIsTimeString_ISO>;
    const isTZ = jUtil.getPureFn('mionFormats', 'mionIsTimeZone') as ReturnType<typeof mionIsTimeZone>;
...
export function mionIsTimeString_ISO(jUtil: JITUtils) {
    const isH = jUtil.getPureFn('mionFormats', 'mionIsHours') as ReturnType<typeof mionIsHours>;
    const isM = jUtil.getPureFn('mionFormats', 'mionIsMinutes') as ReturnType<typeof mionIsMinutes>;
    const isSWithMls = jUtil.getPureFn('mionFormats', 'mionIsSecondsWithMs') as ReturnType<typeof mionIsSecondsWithMs>;
    return function is_iso_time(value: string): boolean {
...
registerPureFnClosure('mionFormats', mionIsTimeString_ISO_TZ, pureTimeFns);
registerPureFnClosure('mionFormats', mionIsTimeString_ISO, pureTimeFns);
registerPureFnClosure('mionFormats', mionIsTimeString_HHmmss, pureTimeFns);
registerPureFnClosure('mionFormats', mionIsTimeString_HHmm, pureTimeFns);
registerPureFnClosure('mionFormats', mionIsTimeString_mmss, pureTimeFns);
