...
export interface RouterOptions<Req = any, ContextData extends Record<string, any> = any> extends CoreRouterOptions {
     ...
     * and will NOT load `@mionjs/run-types` at runtime.
     * Throws an `AOTCacheError` if any route/middleFn is missing from the cache.
     * Import the data from `virtual:mion-aot/caches`.
     *
     * @example
