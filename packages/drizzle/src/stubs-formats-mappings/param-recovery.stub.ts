...
// One extractor pair per dialect: a SQLiteColumn structurally matches a loose
// PgColumn<infer ...> pattern, so a combined conditional infers the wrong config.
...
// pg numeric precision/scale and mysql decimal precision/scale are gone
