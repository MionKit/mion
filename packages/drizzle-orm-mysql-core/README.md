...
🚀 Declare drizzle-orm/mysql-core tables as usual and get **mion Type Formats** fidelity in the inferred models, plus type-level table refinement (refineTable + InferSelect/InferInsert/InferUpdate). Versioned in lockstep with drizzle-orm minor lines.
