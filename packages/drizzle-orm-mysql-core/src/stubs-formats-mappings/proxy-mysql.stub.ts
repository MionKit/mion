...
// Type-level pins for the @mionjs/drizzle-orm-mysql-core proxy builders. Never
// executed - compiled by tsconfig.stubs.json via type-inference.spec.ts.

import type {InferSelectModel} from 'drizzle-orm';
import {bigint, datetime, decimal, int, mysqlTable, serial, smallint, timestamp, tinyint, varchar, year} from '../index.ts';
