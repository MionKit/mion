...
// Type-level table refinement + model derivation for @mionjs/drizzle-orm-mysql-core.
...
export type RefinedTable<T extends MySqlTable, R> =
  T extends MySqlTable<infer Config>
    ? MySqlTableWithColumns<{
        name: Config['name'];
        schema: Config['schema'];
        dialect: Config['dialect'];
        columns: Assume<RefineColumns<Config['columns'], R>, Record<string, MySqlColumn>>;
      }>
    : never;
...
export function refineTableType<T extends MySqlTable, const R extends TableRefinements<T>>(
  table: T,
  refinements: R
): RefinedTable<T, R> {
  void refinements;
...
export type InferSelect<T extends MySqlTable> = InferSelectModel<T>;
/** Insert payload of a (refined) table: generated columns removed, defaulted optional. */
export type InferInsert<T extends MySqlTable> = InferInsertModel<T>;
/** Update payload of a (refined) table: any subset of the insert payload. */
export type InferUpdate<T extends MySqlTable> = UpdateModel<InferInsertModel<T>>;
