...
/**
 * Options accepted by `initClient`. Extends `ClientOptions` with a one-time bootstrap
 * `aotCaches` argument, loaded into the global jit/pure caches at init and not stored
 * in client state.
 */
