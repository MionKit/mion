...
// The one door into the fetched lane: the metadata request, the cache-into-store logic, the store engines,
// eviction and the persistence prompt. Only the loader next door reaches it, when a call needs it.
