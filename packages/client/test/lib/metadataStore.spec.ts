...
import {getMetadataStore, MemoryMetadataStore, resetMetadataStore} from '../../src/lib/metadataStore.ts';
import type {MetadataRecord, MetadataStore, MetadataStoreFactory} from '../../src/lib/storage.ts';
