...
import {createCloudflareHandler, resetCloudflareHandlerOpts, setCloudflareHandlerOpts} from '@mionkit/platform-cloudflare';
...
// ############# AOT Compilation #############
// When running under vite-node for AOT cache generation (MION_COMPILE=true),
