(function(exports) {
  ...
  const __ΩOmit$1 = ["T", "K", () => __ΩPick$4, () => __ΩExclude$1, "Omit", 'b!b"e!!e!!ge!"o$#o##w%y'];
  const __ΩRecord$8 = ["K", "T", "Record", `l'e#"Rb!b"Pde"!N#!w#y`];
  ...
  const __ΩMionRequest = [() => __ΩReadonly$3, () => __ΩOmit$1, () => __ΩMionHeaders, "append", "set", "delete", "headers", () => __ΩRawRequestBody, "rawBody", "SerializerCode", "bodyType", () => __ΩReadonly$3, "AnyObject", "body", () => __ΩReadonly$3, () => __ΩRecord$8, "RpcError", "thrownErrors", "MionRequest", `Pn#P.$.%.&Jo"#o!"4'9n(4)9"w*4+9"w-o,"4.9&"w1o0#o/"4289Mw3y`];
  ...
  const __ΩResponseBody = [() => __ΩRecord$8, () => __ΩRecord$8, "RpcError", "@thrownErrors", "ResponseBody", 'P&"o!#&"w#o"#4$8Mw%y'];
  ...
  const __ΩPartial$2 = ["T", "Partial", 'l+e#!e"!fRb!Pde"!gN#"w"y'];
  ...
  const __ΩRouteOptions = [() => __ΩPartial$2, () => __ΩPick$3, () => __ΩRouteMethod, "options", "description", "validateParams", "validateReturn", "serializer", "RouteOptions", `n#.$fP.%.&.'.(Jo"#o!"w)y`];
  const __ΩMiddleFnOptions = [() => __ΩPartial$2, () => __ΩPick$3, () => __ΩMiddleFnMethod, "options", "description", "validateParams", "validateReturn", "runOnError", "MiddleFnOptions", `n#.$fP.%.&.'.(Jo"#o!"w)y`];
  const __ΩHeadersMiddleFnOptions = [() => __ΩPartial$2, () => __ΩPick$3, () => __ΩHeadersMethod, "options", "description", "validateParams", "validateReturn", "runOnError", "HeadersMiddleFnOptions", `n#.$fP.%.&.'.(Jo"#o!"w)y`];
  const __ΩRawMiddleFnOptions = [() => __ΩPartial$2, () => __ΩPick$3, () => __ΩRawMethod, "options", "description", "runOnError", "RawMiddleFnOptions", `n#.$fP.%.&Jo"#o!"w'y`];
  ...
  const __ΩJitFunctionsCache = [() => __ΩRecord$7, () => __ΩJitCompiledFn, "JitFunctionsCache", '&n"o!#w#y'];
  const __ΩPureFunctionsCache = [() => __ΩRecord$7, () => __ΩRecord$7, () => __ΩCompiledPureFunction, "PureFunctionsCache", '&&n#o"#o!#w$y'];
  const __ΩFnsDataCache = [() => __ΩRecord$7, () => __ΩJitCompiledFnData, "FnsDataCache", '&n"o!#w#y'];
  const __ΩPureFnsDataCache = [() => __ΩRecord$7, () => __ΩRecord$7, () => __ΩPureFunctionData, "PureFnsDataCache", '&&n#o"#o!#w$y'];
  ...
  const __ΩSrcCodeJITCompiledFnsCache = [() => __ΩRecord$7, () => __ΩSrcCodeJitCompiledFn, "SrcCodeJITCompiledFnsCache", '&n"o!#w#y'];
  const __ΩSrcCodePureFunctionsCache = [() => __ΩRecord$7, () => __ΩRecord$7, () => __ΩSrcCodeCompiledPureFunction, "SrcCodePureFunctionsCache", '&&n#o"#o!#w$y'];
  const __ΩAnyFn = ["args", "", "AnyFn", 'P"@2!"/"w#y'];
  const __ΩAnyObject = [() => __ΩRecord$7, "AnyObject", '&#o!#w"y'];
  ...
  const __ΩMethodsCache = [() => __ΩRecord$6, () => __ΩMethodWithOptions, "MethodsCache", '&n"o!#w#y'];
  ...
  const DEFAULT_OPTIONS = {
    ...
    responseAverageSizes: (Map.Ω = [["&"], ["'"]], /* @__PURE__ */ new Map()),
    stringBytesCache: (Map.Ω = [["&"], ["W"]], /* @__PURE__ */ new Map())
  };
  ...
  createDataViewSerializer.__type = ["routeId", "workflowRouteIds", "DataViewSerializer", "createDataViewSerializer", 'P&2!&F2"8"w#/$'];
  ...
  createDataViewDeserializer.__type = ["routeId", "BinaryInput", "input", "DataViewDeserializer", "createDataViewDeserializer", 'P&2!"w"2#"w$/%'];
  class DataViewSerializerImpl {
    ...
    serString(str, skipCache) {
      ...
      if (opts.stringBytesCache.size >= opts.maxCacheSize)
        evictStringBytesCache();
    ...
    static __type = ["buffer", "uint8View", "routeId", "index", function() {
      return 0;
    }, () => __ΩDataView, "view", "hasEnded", function() {
      return false;
    }, "size", "constructor", "reset", "resize", "StrictArrayBuffer", "getBuffer", "getBufferView", "markAsEnded", "getLength", "str", "skipCache", "serString", "n", "serFloat64", "serEnum", "bitMaskIndex", "bitIndex", "setBitMask", "DataViewSerializer", "DataViewSerializerImpl", `_3!9W3";&3#9'3$>%n&3')3(>)P&2#'2*"0+P$0,P'2*$0-P"w.0/PW00P$01P'02P&23)248$05P'26$07PP'&J26$08P'29'2:$0;5"w<x"w=`];
  }
  class DataViewDeserializerImpl {
    ...
    static __type = ["StrictArrayBuffer", "buffer", "uint8View", "routeId", "index", function() {
      return 0;
    }, () => __ΩDataView, "view", "hasEnded", function() {
      return false;
    }, "byteOffset", "byteLength", "constructor", "reset", "setBuffer", "markAsEnded", "getLength", "desString", "desSafePropName", "desFloat64", "desEnum", "DataViewDeserializer", "DataViewDeserializerImpl", `"w!3"9W3#;&3$9'3%>&n'3()3)>*P&2$"w!2"'2+8'2,8"0-P$0.P"w!2"'2+8'2,8$0/P$00P'01P&02P&03P'04PP'&J055"w6x"w7`];
  }
  ...
  calculateBufferSizeForRequest.__type = ["routeId", "workflowRouteIds", "calculateBufferSizeForRequest", `P&2!&F2"8'/#`];
  ...
  calculateDefaultBufferSize.__type = ["routeId", "calculateDefaultBufferSize", `P&2!'/"`];
  ...
  updateResponseSize.__type = ["routeId", "responseSize", "updateResponseSize", `P&2!'2""/#`];
  ...
  evictStringBytesCache.__type = ["evictStringBytesCache", "P$/!"];
  function __assignType$c(fn, args) {
    fn.__type = args;
    return fn;
  }
  function restoreCompiledJitFns(jitCache, pureCache, jUtil) {
    const visitedPure = (Set.Ω = [["&"]], /* @__PURE__ */ new Set());
    const visitedJit = (Set.Ω = [["&"]], /* @__PURE__ */ new Set());
    for (const namespace in pureCache) {
      const nsCache = pureCache[namespace];
      const keysPureFns = Object.keys(nsCache);
      keysPureFns.forEach(__assignType$c((key) => restoreCompiledPureFn(pureCache, namespace, key, jUtil, visitedPure), ["key", "", 'P"2!"/"']));
    }
    const keysJitFns = Object.keys(jitCache);
    keysJitFns.forEach(__assignType$c((key) => restoreCompiledJitFn(jitCache, pureCache, key, jUtil, visitedPure, visitedJit), ["key", "", 'P"2!"/"']));
  }
  restoreCompiledJitFns.__type = ["PersistedJitFunctionsCache", "FnsDataCache", "jitCache", "PureFunctionsCache", "PersistedPureFunctionsCache", "PureFnsDataCache", "pureCache", () => __ΩJITUtils, "jUtil", "restoreCompiledJitFns", `PP"w!"w"J2#P"w$"w%"w&J2'n(2)$/*`];
  function restoreCompiledPureFn(pureCache, namespace, fnName, jUtil, visited) {
    ...
    const nsCache = pureCache[namespace];
    if (!nsCache)
      throw new Error(`Pure function namespace ${namespace} not found`);
    const pureCompiled = nsCache[fnName];
    if (!pureCompiled)
      throw new Error(`Pure function ${fnName} not found in namespace ${namespace}`);
    if (pureCompiled.fn)
      return;
    const dependencies = pureCompiled.pureFnDependencies;
    dependencies.forEach(__assignType$c((depName) => restoreCompiledPureFn(pureCache, namespace, depName, jUtil, visited), ["depName", "", 'P"2!"/"']));
  ...
  restoreCompiledPureFn.__type = ["PureFunctionsCache", "PersistedPureFunctionsCache", "PureFnsDataCache", "pureCache", "namespace", "fnName", () => __ΩJITUtils, "jUtil", "visited", "restoreCompiledPureFn", `PP"w!"w""w#J2$&2%&2&n'2(&D2)"/*`];
  function restoreCompiledJitFn(jitCache, pureCache, fnHash, jUtil, visitedPure, visitedJit) {
    if (visitedJit.has(fnHash))
      return;
    ...
    pureDependencies.forEach(__assignType$c((dep) => {
      const parts = dep.split("::");
      if (parts.length !== 2)
        throw new Error(`Invalid pure function dependency format: ${dep}, expected "namespace::fnHash"`);
    ...
    dependencies.forEach(__assignType$c((dep) => restoreCompiledJitFn(jitCache, pureCache, dep, jUtil, visitedPure, visitedJit), ["dep", "", 'P"2!"/"']));
  ...
  restoreCompiledJitFn.__type = ["PersistedJitFunctionsCache", "FnsDataCache", "jitCache", "PureFunctionsCache", "PersistedPureFunctionsCache", "PureFnsDataCache", "pureCache", "fnHash", () => __ΩJITUtils, "jUtil", "visitedPure", "visitedJit", "restoreCompiledJitFn", `PP"w!"w"J2#P"w$"w%"w&J2'&2(n)2*&D2+&D2,"/-`];
  ...
  restoreCreateJitFn.__type = ["JitCompiledFnData", "fnData", () => __ΩJITUtils, "jUtil", "JitCompiledFn", "restoreCreateJitFn", 'P"w!2"n#2$"w%/&'];
  ...
  restorePureFunction.__type = ["PureFunctionData", "pureFnData", () => __ΩJITUtils, "jUtil", "CompiledPureFunction", "restorePureFunction", 'P"w!2"n#2$"w%/&'];
  ...
  const deserializeFnsRegistry = (Map.Ω = [["&"], ["DeserializeClassFn", '"w!']], /* @__PURE__ */ new Map());
  const serializableClassRegistry = (Map.Ω = [["&"], ["SerializableClass", '"w!']], /* @__PURE__ */ new Map());
  const __ΩJITUtils = ["JitCompiledFn", "comp", "addToJitCache", "removeFromJitCache", "jitFnHash", "getJIT", "args", "", "getJitFn", "hasJitFn", "namespace", () => __ΩCompiledPureFunction, "compiledFn", "addPureFn", "name", () => __ΩPureFunction, "usePureFn", () => __ΩPureFunction, "getPureFn", () => __ΩCompiledPureFunction, "getCompiledPureFn", "hasPureFn", () => __ΩCompiledPureFunction, "findCompiledPureFn", "cls", "setSerializableClass", "className", "SerializableClass", "useSerializeClass", "getSerializeClass", "DeserializeClassFn", "deserializeFn", "setDeserializeFn", "useDeserializeFn", "getDeserializeFn", "JITUtils", `PP"w!2"$1#P"w!2"$1$P&2%P"w!-J1&P&2%P"@2'"/(1)P&2%)1*P&2+n,2-$1.P&2+&2/n011P&2+&2/Pn2-J13P&2+&2/Pn4-J15P&2+&2/)16P&2/Pn7-J18P"29$1:P&2;"w<1=P&2;P"w<-J1>P"29"w?2@$1AP&2;"w?1BP&2;P"w?-J1CMwDy`];
  const jitUtils = {
    addToJitCache: __assignType$b(function addToJitCache(comp) {
      jitFnsCache$1[comp.jitFnHash] = comp;
    }, ["JitCompiledFn", "comp", "addToJitCache", 'P"w!2""/#']),
    removeFromJitCache: __assignType$b(function removeFromJitCache(comp) {
      if (!jitFnsCache$1[comp.jitFnHash])
        return;
      jitFnsCache$1[comp.jitFnHash] = void 0;
    }, ["JitCompiledFn", "comp", "removeFromJitCache", 'P"w!2""/#']),
    getJIT: __assignType$b(function getJIT(jitFnHash) {
      return jitFnsCache$1[jitFnHash];
    }, ["jitFnHash", "JitCompiledFn", "getJIT", 'P&2!P"w"-J/#']),
    getJitFn: __assignType$b(function getJitFn(jitFnHash) {
    ...
    hasJitFn: __assignType$b(function hasJitFn(jitFnHash) {
     ...
     *  */
    addPureFn: __assignType$b(function addPureFn(namespace, compiledFn) {
      ...
      if (existing) {
        if (existing.bodyHash && compiledFn.bodyHash && existing.bodyHash !== compiledFn.bodyHash) {
          console.warn(`Pure function ${namespace}::${fnHash} body hash mismatch. Existing: ${existing.bodyHash}, New: ${compiledFn.bodyHash}. Replacing with new version.`);
      ...
      nsCache[fnHash] = compiledFn;
      return compiledFn;
    }, ["namespace", () => __ΩCompiledPureFunction, "compiledFn", () => __ΩCompiledPureFunction, "addPureFn", 'P&2!n"2#n$/%']),
    usePureFn: __assignType$b(function usePureFn(namespace, fnHash) {
      const nsCache = pureFnsCache$1[namespace];
      if (!nsCache)
        throw new Error(`Pure function namespace ${namespace} not found`);
      const compiled = nsCache[fnHash];
      if (!compiled)
        throw new Error(`Pure function with name ${fnHash} not found in namespace ${namespace}`);
      initPureFunction(compiled);
      return compiled.fn;
    }, ["namespace", "fnHash", () => __ΩPureFunction, "usePureFn", 'P&2!&2"n#/$']),
    getPureFn: __assignType$b(function getPureFn(namespace, fnHash) {
      const nsCache = pureFnsCache$1[namespace];
      if (!nsCache)
        return;
      const compiled = nsCache[fnHash];
      ...
      initPureFunction(compiled);
      return compiled.fn;
    }, ["namespace", "fnHash", () => __ΩPureFunction, "getPureFn", 'P&2!&2"Pn#-J/$']),
    getCompiledPureFn: __assignType$b(function getCompiledPureFn(namespace, fnHash) {
      const nsCache = pureFnsCache$1[namespace];
      if (!nsCache)
        return;
      return nsCache[fnHash];
    }, ["namespace", "fnHash", () => __ΩCompiledPureFunction, "getCompiledPureFn", 'P&2!&2"Pn#-J/$']),
    hasPureFn: __assignType$b(function hasPureFn(namespace, fnHash) {
      const nsCache = pureFnsCache$1[namespace];
      if (!nsCache)
        return false;
      return !!nsCache[fnHash];
    }, ["namespace", "fnHash", "hasPureFn", 'P&2!&2")/#']),
    findCompiledPureFn: __assignType$b(function findCompiledPureFn(fnHash) {
      for (const namespace of Object.keys(pureFnsCache$1)) {
        const nsCache = pureFnsCache$1[namespace];
        if (nsCache && nsCache[fnHash])
          return nsCache[fnHash];
      }
      return void 0;
    }, ["fnHash", () => __ΩCompiledPureFunction, "findCompiledPureFn", 'P&2!Pn"-J/#']),
    setSerializableClass: __assignType$b(function setSerializableClass(cls) {
    ...
    useSerializeClass: __assignType$b(function useSerializeClass(className) {
    ...
    getSerializeClass: __assignType$b(function getSerializeClass(className) {
      return serializableClassRegistry.get(className);
    }, ["className", "SerializableClass", "getSerializeClass", 'P&2!P"w"-J/#']),
    setDeserializeFn: __assignType$b(function setDeserializeFn(cls, deserializeFn) {
      const className = cls.name;
    ...
    useDeserializeFn: __assignType$b(function useDeserializeFn(className) {
      const fn = deserializeFnsRegistry.get(className);
      if (!fn)
    ...
    getDeserializeFn: __assignType$b(function getDeserializeFn(className) {
  ...
  getJitUtils.__type = [() => __ΩJITUtils, "getJitUtils", 'Pn!/"'];
  function addAOTCaches(aotFnsCache, aotPureCache) {
    restoreCaches(aotFnsCache, aotPureCache);
  }
  addAOTCaches.__type = ["PersistedJitFunctionsCache", "aotFnsCache", "PersistedPureFunctionsCache", "aotPureCache", "addAOTCaches", 'P"w!2""w#2$"/%'];
      ...
      for (const key in sourceNsCache) {
        ...
        if (existing) {
          if (existing.bodyHash && incoming.bodyHash && existing.bodyHash !== incoming.bodyHash) {
            console.warn(`Pure function ${namespace}::${key} cache eviction: bodyHash mismatch (cached: ${existing.bodyHash}, server: ${incoming.bodyHash})`);
  ...
  restoreCaches.__type = ["PersistedJitFunctionsCache", "FnsDataCache", "fnsCache", "PersistedPureFunctionsCache", "PureFnsDataCache", "pureCache", "restoreCaches", `PP"w!"w"J2#P"w$"w%J2&"/'`];
  ...
  getJitFnCaches.__type = ["getJitFnCaches", 'P"/!'];
  ...
  ensureNamespace.__type = ["namespace", () => __ΩRecord$5, () => __ΩCompiledPureFunction, "ensureNamespace", 'P&2!&n#o"#/$'];
  ...
  randomUUID_V7.__type = ["randomUUID_V7", "P&/!"];
  function getENV(key) {
  ...
  getENV.__type = ["key", "getENV", 'P&2!P&-J/"'];
  let isTest = void 0;
  function isTestEnv() {
    if (isTest !== void 0)
      return isTest;
  ...
  const __ΩReturnType$2 = ["T", "args", "", "ReturnType", `l>e"!R"RPde#!P"@2"h"!/#qk#'QRb!Pde"!p)w$y`];
  ...
  serializeBinaryBody$1.__type = ["path", "MethodWithJitFns", "executionChain", () => __ΩRecord$4, "body", "isResponse", "workflowRouteIds", "DataViewSerializer", "serializer", () => __ΩReturnType$2, "getBuffer", "buffer", "serializeBinaryBody", `P&2!"w"F2#&"o$#2%)2&&F2'8P"w(4)"w(.+fo*"4,M/-`];
  function serializeMethod(key, method, value, serializer, isResponse) {
    ...
    if (toBinary.isNoop)
      return false;
    if (key === MION_ROUTES.thrownErrors)
      return false;
    if (isResponse && (!method.hasReturnData || typeof value === "undefined"))
      return false;
    if (!isResponse && typeof value === "undefined")
      return false;
    serializer.serString(key);
    toBinary.fn(value, serializer);
    return true;
  }
  serializeMethod.__type = ["key", "MethodWithJitFns", "method", "value", "DataViewSerializer", "serializer", "isResponse", "serializeMethod", `P&2!"w"2#"2$"w%2&)2')/(`];
  ...
  const jitFunctionsCache = (Map.Ω = [["&"], ["JitCompiledFunctions", '"w!']], /* @__PURE__ */ new Map());
  const headerJitFunctionsCache = (Map.Ω = [["&"], [() => __ΩPick$1, "JitCompiledFunctions", "isType", "typeErrors", '"w"P.#.$Jo!#']], /* @__PURE__ */ new Map());
  const routesCache = {
    /**
     ...
     */
    getMetadata: __assignType$a(function getMetadata(id) {
      return methodsCache[id];
    }, ["id", "MethodWithOptions", "getMetadata", 'P&2!P"w"-J/#']),
    /**
     * Set method metadata in the router cache
     * @param id - The method id
     * @param methodData - The method metadata
     */
    setMetadata: __assignType$a(function setMetadata(id, methodData) {
      methodsCache[id] = methodData;
    }, ["id", "MethodWithOptions", "methodData", "setMetadata", 'P&2!"w"2#$/$']),
    /**
     * Check if the router cache contains a method by id.
     * @param id - The method id
     * @returns True if the method exists in the cache
     */
    hasMetadata: __assignType$a(function hasMetadata(id) {
     ...
     */
    getCache: __assignType$a(function getCache() {
      return methodsCache;
    }, ["MethodsCache", "getCache", 'P"w!/"']),
    /**
     ...
     */
    getMethodJitFns: __assignType$a(function getMethodJitFns(id) {
      ...
      return result;
    }, ["id", "MethodWithOptsAndJitFns", "getMethodJitFns", 'P&2!P"w"-J/#']),
    /**
     * Get method metadata with JIT functions restored from the router cache by id.
     * @param id
     * @returns
     */
    useMethodJitFns: __assignType$a(function useMethodJitFns(id) {
      const MethodWithOptsAndJitFns = this.getMethodJitFns(id);
      if (!MethodWithOptsAndJitFns)
        throw new Error(`Metadata for remote method ${id} not found`);
      return MethodWithOptsAndJitFns;
    }, ["id", "useMethodJitFns", 'P&2!!/"']),
    /**
     ...
     */
    setMethodJitFns: __assignType$a(function setMethodJitFns(id, MethodWithOptsAndJitFns) {
      methodsCache[id] = MethodWithOptsAndJitFns;
    }, ["id", "MethodWithOptsAndJitFns", "setMethodJitFns", 'P&2!"w"2"$/#'])
  };
  ({
    getMethodOptions: __assignType$a(function getMethodOptions(id) {
      return methodsOptionsCache[id];
    }, ["id", "RemoteMethodOpts", "getMethodOptions", 'P&2!P"w"-J/#']),
    setMethodOptions: __assignType$a(function setMethodOptions(id, options2) {
      methodsOptionsCache[id] = options2;
    }, ["id", "RemoteMethodOpts", "options", "setMethodOptions", 'P&2!"w"2#$/$'])
  });
  ...
  addRoutesToCache.__type = ["MethodsCache", "newCache", "addRoutesToCache", 'P"w!2""/#'];
  ...
  getJitFnHashes.__type = ["jitHash", "JitFunctionsHashes", "getJitFnHashes", 'P&2!"w"/#'];
  function getJitFunctionsFromHash(jitHash) {
    if (jitHash === EMPTY_HASH)
      return noopJitFns;
    ...
    for (const key in jitFns) {
      if (!jitFns[key])
        throw new Error(`Jit function ${key} not found for jitHash ${jitHash}`);
    }
    jitFunctionsCache.set(jitHash, jitFns);
    return jitFns;
  }
  getJitFunctionsFromHash.__type = ["jitHash", "JitCompiledFunctions", "getJitFunctionsFromHash", 'P&2!"w"/#'];
  ...
  getHeaderJitFunctionsFromHash.__type = ["jitHash", () => __ΩPick$1, "JitCompiledFunctions", "isType", "typeErrors", "getHeaderJitFunctionsFromHash", 'P&2!"w#P.$.%Jo"#/&'];
  function getRouterItemId(itemPointer) {
    return itemPointer.join(ROUTER_ITEM_SEPARATOR_CHAR);
  }
  getRouterItemId.__type = ["itemPointer", "getRouterItemId", 'P&F2!"/"'];
  ...
  getRoutePath.__type = ["pathPointer", "prefix", "suffix", "routerOptions", "getRoutePath", 'P&F2!P&4"&4#M2$"/%'];
  function resetRoutesCache() {
    for (const k in methodsCache)
      delete methodsCache[k];
  }
  resetRoutesCache.__type = ["resetRoutesCache", 'P"/!'];
  const noopJitFns = {
  ...
  fakeJitFn.__type = ["fnID", "JitCompiledFn", "fakeJitFn", 'P&2!"w"/#'];
  function getNoopJitFns() {
    return noopJitFns;
  }
  getNoopJitFns.__type = ["JitCompiledFunctions", "getNoopJitFns", 'P"w!/"'];
  ...
  deserializeBinaryBody.__type = ["path", "BinaryInput", "buffer", "isResponse", "DataViewDeserializer", "deserializer", () => __ΩRecord$3, "body", "deserializeBinaryBody", `P&2!"w"2#)2$P"w%4&&"o'#4(M/)`];
  ...
  deserializeMethod.__type = ["key", "MethodWithJitFns", "method", "DataViewDeserializer", "deserializer", "isResponse", "deserializeMethod", `P&2!"w"2#"w$2%)2&"/'`];
  class HeadersSubset {
    headers;
    constructor(headers) {
...
Regenerate AOT caches using 'mion-build-aot' command.`);
  ...
  async function loadRunTypesModule() {
    ...
    runTypesLoadPromise = Promise.resolve().then(() => runTypes$1).then(__assignType$9((module) => {
      runTypesModule = {
  ...
  function getReturnHeadersRunType(handlerRunType, rt) {
    ...
    if (rt.isUnionRunType(returnRunType)) {
      const headersSubset = returnRunType.getChildRunTypes().find(__assignType$9((child) => isHeaderSubSetRunType(child, rt), ["child", "", 'P"2!"/"']));
      if (!headersSubset)
        return void 0;
      return headersSubset;
    }
  ...
  function recursiveGetSerializableRoutes(routes, currentPointer = [], publicData = {}) {
    ...
    entries.forEach(__assignType$8(([key, item]) => {
  ...
  function getSerializableMethod(executable) {
    ...
    if (executable.type === HandlerType$1.route) {
      ...
      const pathPointers = getRouteExecutionChain(path)?.methods.filter(__assignType$8((exec) => isPublicExecutable(exec), ["exec", "", 'P"2!"/"'])).map(__assignType$8((exec) => exec.pointer, ["exec", "", 'P"2!"/"'])) || [];
      newRemoteMethod.middleFnIds = pathPointers.map(__assignType$8((pointer) => getRouterItemId(pointer), ["pointer", "", 'P"2!"/"'])).filter(__assignType$8((id) => {
  ...
  function serializePureDeps(namespacedDepHash, purFnDeps, depth = 0) {
    ...
    pureDep.pureFnDependencies.forEach(__assignType$8((depFnHash) => serializePureDeps(`${namespace}::${depFnHash}`, purFnDeps, depth + 1), ["depFnHash", "", 'P"2!"/"']));
  }
  ...
  function serializeJitFn(jitFnHash, deps, purFnDeps, depth = 0) {
    ...
    jitFn.jitDependencies.forEach(__assignType$8((h) => serializeJitFn(h, deps, purFnDeps, depth + 1), ["h", "", 'P"2!"/"']));
    jitFn.pureFnDependencies.forEach(__assignType$8((h) => serializePureDeps(h, purFnDeps), ["h", "", 'P"2!"/"']));
  }
  serializeJitFn.__type = ["jitFnHash", () => __ΩRecord$2, "JitCompiledFnData", "deps", "PureFnsDataCache", "purFnDeps", "depth", "serializeJitFn", `P&2!&"w#o"#2$"w%2&"2'"/(`];
  ...
  serializeMethodDeps.__type = ["MethodWithOptions", "method", () => __ΩRecord$2, "JitCompiledFnData", "deps", "PureFnsDataCache", "purFnDeps", "serializeMethodDeps", `P"w!2"&"w$o##2%"w&2'"/(`];
  ...
  function mionGetRemoteMethodsDataById(ctx, methodsIds, getAllRemoteMethods) {
    ...
    const idsToReturn = shouldReturnAll ? getAllExecutablesIds().filter(__assignType$7((id) => !mionInternalRoutes.includes(id) && !isPrivateExecutable(getAnyExecutable(id)), ["id", "", 'P"2!"/"'])) : methodsIds;
    idsToReturn.forEach(__assignType$7((id) => addRequiredRemoteMethodsToResponse(id, resp, errorData), ["id", "", 'P"2!"/"']));
  ...
  function mionGetRemoteMethodsDataByPath(ctx, path, getAllRemoteMethods) {
    ...
    const privateExecutables = executables.methods.filter(__assignType$7((e) => !isPrivateExecutable(e), ["e", "", 'P"2!"/"']));
    return mionGetRemoteMethodsDataById(ctx, privateExecutables.map(__assignType$7((e) => e.id, ["e", "", 'P"2!"/"'])), getAllRemoteMethods);
  }
  ...
  function addRequiredRemoteMethodsToResponse(id, resp, errorData) {
    ...
    methods[id] = method;
    method.middleFnIds?.forEach(__assignType$7((middleFnId) => addRequiredRemoteMethodsToResponse(middleFnId, resp, errorData), ["middleFnId", "", 'P"2!"/"']));
  ...
  const mionErrorsRoutes = {
     ...
     */
    [MION_ROUTES.thrownErrors]: route(__assignType$6((ctx) => {
     ...
     */
    [MION_ROUTES.notFound]: route(__assignType$6((ctx) => {
      throw new RpcError({
     ...
     * This also prevents users to register a route with the same name.
     */
    [MION_ROUTES.platformError]: route(__assignType$6((_ctx) => {
      return new RpcError({
  ...
  function getRoutesFlowExecutionChain(rawRequest, opts2, urlQuery) {
    ...
    const routeIds = routePaths.map(__assignType$5((path) => path.startsWith("/") ? path.slice(1) : path, ["path", "", 'P"2!"/"']));
  ...
  function buildMergedExecutionChain(routePaths, rawRequest, opts2, mappings) {
    ...
    const startMiddleFnIds = new Set(startMiddleFns.map(__assignType$5((m) => m.id, ["m", "", 'P"2!"/"'])));
    const endMiddleFnIds = new Set(endMiddleFns.map(__assignType$5((m) => m.id, ["m", "", 'P"2!"/"'])));
  ...
  function insertMappingMethods(middleMethods, mappings) {
    ...
    insertions.sort(__assignType$5((a, b) => b.index - a.index, ["a", "b", "", 'P"2!"2""/#']));
  ...
  let startMiddleFns = [];
  let endMiddleFns = [];
  const getRouteExecutionChain = __assignType$4((path) => flatRouter.get(path), ["path", "", 'P&2!"/"']);
  const getRouteExecutable = __assignType$4((id) => routesById.get(id), ["id", "", 'P&2!"/"']);
  const getMiddleFnExecutable = __assignType$4((id) => middleFnsById.get(id), ["id", "", 'P&2!"/"']);
  const getRouterOptions = __assignType$4(() => routerOptions, [() => __ΩReadonly, "", 'P"o!"/"']);
  const getAnyExecutable = __assignType$4((id) => routesById.get(id) || middleFnsById.get(id) || rawMiddleFnsById.get(id), ["id", "", 'P&2!"/"']);
  const resetRouter = () => {
    flatRouter.clear();
    middleFnsById.clear();
    routesById.clear();
  ...
  initMionRouter.__type = ["routes", () => __ΩPartial$1, "RouterOptions", "opts", "PublicApi", "initMionRouter", 'P"2!"w#o""2$8"w%`/&'];
  ...
  initRouter.__type = [() => __ΩPartial$1, "RouterOptions", "opts", () => __ΩReadonly, "initRouter", 'P"w"o!"2#8"w"o$"`/%'];
  ...
  async function recursiveFlatRoutes(routes, currentPointer = [], preMiddleFns = [], postMiddleFns = [], nestLevel = 0) {
    ...
    for (let index = 0; index < entries.length; index++) {
      ...
      if (key.includes(","))
        throw new Error(`Invalid route: ${join(...newPointer)}. Route names cannot contain commas.`);
      if (key === WORKFLOW_KEY)
      ...
      if (isAnyMiddleFnDef(item)) {
        ...
        if (middleFnNames.has(routeEntry.id))
          throw new Error(`Invalid middleFn: ${join(...newPointer)}. Naming collision, Naming collision, duplicated middleFn.`);
      ...
      minus1Props = await recursiveCreateExecutionChainAsync(routeEntry, newPointer, preMiddleFns, postMiddleFns, nestLevel, index, entries, minus1Props);
    }
  }
  recursiveFlatRoutes.__type = ["Routes", "routes", "currentPointer", () => [], "RemoteMethod", "preMiddleFns", () => [], "postMiddleFns", () => [], "nestLevel", "recursiveFlatRoutes", `P"w!2"&F2#>$"w%F2&>'"w%F2(>)"2*"/+`];
  async function recursiveCreateExecutionChainAsync(routeEntry, currentPointer, preMiddleFns, postMiddleFns, nestLevel, index, routeKeyedEntries, minus1Props) {
    ...
    if (isExec && props.isRoute) {
      ...
      await recursiveFlatRoutes(routeEntry.routes, routeEntry.pathPointer, [...preMiddleFns, ...props.preLevelMiddleFns], [...props.postLevelMiddleFns, ...postMiddleFns], nestLevel + 1);
    }
    return props;
  }
  recursiveCreateExecutionChainAsync.__type = ["RemoteMethod", () => __ΩRoutesWithId, "routeEntry", "currentPointer", "preMiddleFns", "postMiddleFns", "nestLevel", "index", () => __ΩRouterKeyEntryList, "routeKeyedEntries", () => __ΩReturnType$1, () => getRouteEntryProperties, "minus1Props", "recursiveCreateExecutionChainAsync", `PP"w!n"J2#&F2$"w!F2%"w!F2&'2''2(n)2*Pi,o+",J2-"/.`];
  async function getExecutableFromAnyMiddleFn(middleFn, middleFnPointer, nestLevel) {
    if (isRawMiddleFnDef(middleFn))
      return getExecutableFromRawMiddleFn(middleFn, middleFnPointer, nestLevel);
  ...
  validateSharedDataFactory.__type = [() => __ΩPartial$1, "RouterOptions", "opts", "validateSharedDataFactory", 'P"w"o!"2#8$/$'];
  ...
  async function runHeadersMiddleFn(context, executable, request) {
    ...
    const headersMap = {};
    headerNames.forEach(__assignType$3((name) => {
  ...
  createCloudflareHandler.__type = ["createCloudflareHandler", 'P"/!'];
  ...
  setup.__type = [() => __ΩCloudflareSetupOptions, "options", "setup", 'Pn!2"8"/#'];
...
if (Des.view.getUint8(tbimI0, 1) & (1 << (0))) {ret[0] = fBi_b1N57x.fn(undefined,Des)} if (Des.view.getUint8(tbimI0, 1) & (1 << (1))) {ret[1] = Des.view.getUint8(Des.index++) === 1} ; return ret}`, jitDependencies: ["fBi_b1N57x"], pureFnDependencies: [], createJitFn: function get_fBi_JtnVhp(utl) {
  ...
  }, fn: void 0 }, "is_eeS8mQ": { isNoop: false, typeName: "union", fnID: "is", jitFnHash: "is_eeS8mQ", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_Fh5931 = utl.getJIT("is_Fh5931");
const is_OQaagS = utl.getJIT("is_OQaagS"); return function is_eeS8mQ(v){return ((typeof v === 'object' && v !== null && (is_Fh5931.fn(v) || is_OQaagS.fn(v))))}`, jitDependencies: ["is_Fh5931", "is_OQaagS"], pureFnDependencies: [], createJitFn: function get_is_eeS8mQ(utl) {
    const is_Fh5931 = utl.getJIT("is_Fh5931");
    const is_OQaagS = utl.getJIT("is_OQaagS");
    return function is_eeS8mQ(v) {
      return typeof v === "object" && v !== null && (is_Fh5931.fn(v) || is_OQaagS.fn(v));
    };
  }, fn: void 0 }, "is_Fh5931": { isNoop: false, typeName: "SerializableMethodsData", fnID: "is", jitFnHash: "is_Fh5931", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_mkeGCe = utl.getJIT("is_mkeGCe");
const is_HnJJR1 = utl.getJIT("is_HnJJR1");
const is_cuUMAa = utl.getJIT("is_cuUMAa"); return function is_Fh5931(v){return (is_mkeGCe.fn(v.purFnDeps) && is_HnJJR1.fn(v.methods) && is_cuUMAa.fn(v.deps))}`, jitDependencies: ["is_mkeGCe", "is_HnJJR1", "is_cuUMAa"], pureFnDependencies: [], createJitFn: function get_is_Fh5931(utl) {
    const is_mkeGCe = utl.getJIT("is_mkeGCe");
    const is_HnJJR1 = utl.getJIT("is_HnJJR1");
    const is_cuUMAa = utl.getJIT("is_cuUMAa");
    return function is_Fh5931(v) {
      return is_mkeGCe.fn(v.purFnDeps) && is_HnJJR1.fn(v.methods) && is_cuUMAa.fn(v.deps);
    };
  ...
  }, fn: void 0 }, "is_HnJJR1": { isNoop: false, typeName: "MethodsCache", fnID: "is", jitFnHash: "is_HnJJR1", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_qkOIac = utl.getJIT("is_qkOIac"); return function is_HnJJR1(v){return (typeof v === 'object' && v !== null && (!Array.isArray(v) && Object.prototype.toString.call(v) === '[object Object]') && (function(){for (const p0 in v){if (!(is_qkOIac.fn(v[p0]))) return false;} return true;})())}`, jitDependencies: ["is_qkOIac"], pureFnDependencies: [], createJitFn: function get_is_HnJJR1(utl) {
    const is_qkOIac = utl.getJIT("is_qkOIac");
    return function is_HnJJR1(v) {
      return typeof v === "object" && v !== null && (!Array.isArray(v) && Object.prototype.toString.call(v) === "[object Object]") && (function() {
        for (const p0 in v) {
          if (!is_qkOIac.fn(v[p0])) return false;
        }
        return true;
      })();
    };
  }, fn: void 0 }, "is_qkOIac": { isNoop: false, typeName: "MethodWithOptions", fnID: "is", jitFnHash: "is_qkOIac", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_Ei8qua = utl.getJIT("is_Ei8qua");
const is_s8eky2 = utl.getJIT("is_s8eky2");
const is_VJxRzx = utl.getJIT("is_VJxRzx"); return function is_qkOIac(v){return (typeof v === 'object' && v !== null && Number.isFinite(v.type) && typeof v.id === 'string' && typeof v.isAsync === 'boolean' && typeof v.hasReturnData === 'boolean' && (v.paramNames === undefined || is_Ei8qua.fn(v.paramNames)) && typeof v.paramsJitHash === 'string' && typeof v.returnJitHash === 'string' && (v.headersParam === undefined || is_s8eky2.fn(v.headersParam)) && (v.headersReturn === undefined || is_s8eky2.fn(v.headersReturn)) && (v.middleFnIds === undefined || is_Ei8qua.fn(v.middleFnIds)) && is_Ei8qua.fn(v.pointer) && Number.isFinite(v.nestLevel) && is_VJxRzx.fn(v.options))}`, jitDependencies: ["is_Ei8qua", "is_s8eky2", "is_VJxRzx"], pureFnDependencies: [], createJitFn: function get_is_qkOIac(utl) {
    const is_Ei8qua = utl.getJIT("is_Ei8qua");
    const is_s8eky2 = utl.getJIT("is_s8eky2");
    const is_VJxRzx = utl.getJIT("is_VJxRzx");
    return function is_qkOIac(v) {
      return typeof v === "object" && v !== null && Number.isFinite(v.type) && typeof v.id === "string" && typeof v.isAsync === "boolean" && typeof v.hasReturnData === "boolean" && (v.paramNames === void 0 || is_Ei8qua.fn(v.paramNames)) && typeof v.paramsJitHash === "string" && typeof v.returnJitHash === "string" && (v.headersParam === void 0 || is_s8eky2.fn(v.headersParam)) && (v.headersReturn === void 0 || is_s8eky2.fn(v.headersReturn)) && (v.middleFnIds === void 0 || is_Ei8qua.fn(v.middleFnIds)) && is_Ei8qua.fn(v.pointer) && Number.isFinite(v.nestLevel) && is_VJxRzx.fn(v.options);
    };
...
const is_Ei8qua = utl.getJIT("is_Ei8qua"); return function is_vnf9tn(v){return (typeof v === 'object' && v !== null && typeof v.typeName === 'string' && typeof v.fnID === 'string' && typeof v.jitFnHash === 'string' && is_gCQYSg.fn(v.args) && is_gCQYSg.fn(v.defaultParamValues) && (v.isNoop === undefined || typeof v.isNoop === 'boolean') && typeof v.code === 'string' && is_Ei8qua.fn(v.jitDependencies) && is_Ei8qua.fn(v.pureFnDependencies) && (v.paramNames === undefined || is_Ei8qua.fn(v.paramNames)))}`, jitDependencies: ["is_gCQYSg", "is_Ei8qua"], pureFnDependencies: [], createJitFn: function get_is_vnf9tn(utl) {
  ...
  }, fn: void 0 }, "te_eeS8mQ": { isNoop: false, typeName: "union", fnID: "te", jitFnHash: "te_eeS8mQ", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const is_Fh5931 = utl.getJIT("is_Fh5931");
const is_OQaagS = utl.getJIT("is_OQaagS");
const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_eeS8mQ(v,pth=[],er=[]){if (!((typeof v === 'object' && v !== null && (is_Fh5931.fn(v) || is_OQaagS.fn(v))))) Iqa2M8Ms(pth,er,"union"); return er}`, jitDependencies: ["is_Fh5931", "is_OQaagS"], pureFnDependencies: ["mion::newRunTypeErr"], createJitFn: function get_te_eeS8mQ(utl) {
    const is_Fh5931 = utl.getJIT("is_Fh5931");
    const is_OQaagS = utl.getJIT("is_OQaagS");
    const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr");
    return function te_eeS8mQ(v, pth = [], er = []) {
      if (!(typeof v === "object" && v !== null && (is_Fh5931.fn(v) || is_OQaagS.fn(v)))) Iqa2M8Ms(pth, er, "union");
      return er;
    };
  }, fn: void 0 }, "tj_eeS8mQ": { isNoop: false, typeName: "union", fnID: "tj", jitFnHash: "tj_eeS8mQ", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json encode union: item does not belong to the union";
const is_Fh5931 = utl.getJIT("is_Fh5931");
const tj_Fh5931 = utl.getJIT("tj_Fh5931");
const fj_Fh5931 = utl.getJIT("fj_Fh5931");
const is_OQaagS = utl.getJIT("is_OQaagS");
const tj_OQaagS = utl.getJIT("tj_OQaagS");
const fj_OQaagS = utl.getJIT("fj_OQaagS"); return function tj_eeS8mQ(v){if (typeof v === 'object' && v !== null && is_Fh5931.fn(v)) {v = tj_Fh5931.fn(v); v = [0, v]}else if (typeof v === 'object' && v !== null && is_OQaagS.fn(v)) {v = tj_OQaagS.fn(v); v = [1, v]}else {throw new Error(uErr0);} return v}`, jitDependencies: ["is_Fh5931", "tj_Fh5931", "fj_Fh5931", "is_OQaagS", "tj_OQaagS", "fj_OQaagS"], pureFnDependencies: [], createJitFn: function get_tj_eeS8mQ(utl) {
    const uErr0 = "Can not json encode union: item does not belong to the union";
    const is_Fh5931 = utl.getJIT("is_Fh5931");
    const tj_Fh5931 = utl.getJIT("tj_Fh5931");
    utl.getJIT("fj_Fh5931");
    const is_OQaagS = utl.getJIT("is_OQaagS");
    const tj_OQaagS = utl.getJIT("tj_OQaagS");
    utl.getJIT("fj_OQaagS");
    return function tj_eeS8mQ(v) {
      if (typeof v === "object" && v !== null && is_Fh5931.fn(v)) {
        v = tj_Fh5931.fn(v);
        v = [0, v];
  ...
  }, fn: void 0 }, "tj_Fh5931": { isNoop: false, typeName: "SerializableMethodsData", fnID: "tj", jitFnHash: "tj_Fh5931", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const tj_HnJJR1 = utl.getJIT("tj_HnJJR1"); return function tj_Fh5931(v){v.methods = tj_HnJJR1.fn(v.methods); return v}`, jitDependencies: ["tj_HnJJR1"], pureFnDependencies: [], createJitFn: function get_tj_Fh5931(utl) {
    const tj_HnJJR1 = utl.getJIT("tj_HnJJR1");
    return function tj_Fh5931(v) {
      v.methods = tj_HnJJR1.fn(v.methods);
      return v;
    };
  ...
  }, fn: void 0 }, "tj_HnJJR1": { isNoop: false, typeName: "MethodsCache", fnID: "tj", jitFnHash: "tj_HnJJR1", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const tj_qkOIac = utl.getJIT("tj_qkOIac"); return function tj_HnJJR1(v){for (const p0 in v){ v[p0] = tj_qkOIac.fn(v[p0]);} return v}`, jitDependencies: ["tj_qkOIac"], pureFnDependencies: [], createJitFn: function get_tj_HnJJR1(utl) {
    const tj_qkOIac = utl.getJIT("tj_qkOIac");
    return function tj_HnJJR1(v) {
      for (const p0 in v) {
        v[p0] = tj_qkOIac.fn(v[p0]);
      }
      return v;
    };
  }, fn: void 0 }, "tj_qkOIac": { isNoop: false, typeName: "MethodWithOptions", fnID: "tj", jitFnHash: "tj_qkOIac", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const tj_VJxRzx = utl.getJIT("tj_VJxRzx"); return function tj_qkOIac(v){v.options = tj_VJxRzx.fn(v.options); return v}`, jitDependencies: ["tj_VJxRzx"], pureFnDependencies: [], createJitFn: function get_tj_qkOIac(utl) {
    const tj_VJxRzx = utl.getJIT("tj_VJxRzx");
    return function tj_qkOIac(v) {
  ...
  }, fn: void 0 }, "fj_Fh5931": { isNoop: false, typeName: "SerializableMethodsData", fnID: "fj", jitFnHash: "fj_Fh5931", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_HnJJR1 = utl.getJIT("fj_HnJJR1"); return function fj_Fh5931(v){v.methods = fj_HnJJR1.fn(v.methods); return v}`, jitDependencies: ["fj_HnJJR1"], pureFnDependencies: [], createJitFn: function get_fj_Fh5931(utl) {
    const fj_HnJJR1 = utl.getJIT("fj_HnJJR1");
    return function fj_Fh5931(v) {
      v.methods = fj_HnJJR1.fn(v.methods);
      return v;
    };
  ...
  }, fn: void 0 }, "fj_HnJJR1": { isNoop: false, typeName: "MethodsCache", fnID: "fj", jitFnHash: "fj_HnJJR1", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_qkOIac = utl.getJIT("fj_qkOIac"); return function fj_HnJJR1(v){for (const p0 in v){ v[p0] = fj_qkOIac.fn(v[p0]);} return v}`, jitDependencies: ["fj_qkOIac"], pureFnDependencies: [], createJitFn: function get_fj_HnJJR1(utl) {
    const fj_qkOIac = utl.getJIT("fj_qkOIac");
    return function fj_HnJJR1(v) {
      for (const p0 in v) {
        v[p0] = fj_qkOIac.fn(v[p0]);
      }
      return v;
    };
  }, fn: void 0 }, "fj_qkOIac": { isNoop: false, typeName: "MethodWithOptions", fnID: "fj", jitFnHash: "fj_qkOIac", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_VJxRzx = utl.getJIT("fj_VJxRzx"); return function fj_qkOIac(v){v.options = fj_VJxRzx.fn(v.options); return v}`, jitDependencies: ["fj_VJxRzx"], pureFnDependencies: [], createJitFn: function get_fj_qkOIac(utl) {
    const fj_VJxRzx = utl.getJIT("fj_VJxRzx");
    return function fj_qkOIac(v) {
 ...
 ; return v}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fj_OQaagS(utl) {
  ...
  }, fn: void 0 }, "fj_eeS8mQ": { isNoop: false, typeName: "union", fnID: "fj", jitFnHash: "fj_eeS8mQ", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index";
const fj_Fh5931 = utl.getJIT("fj_Fh5931");
const fj_OQaagS = utl.getJIT("fj_OQaagS"); return function fj_eeS8mQ(v){
 if (v?.length === 2 && Array.isArray(v) && typeof v[0] === 'number') {
 const dec0 = v[0]; v = v[1];
 if (dec0 === 0) {v = fj_Fh5931.fn(v)}else if (dec0 === 1) {v = fj_OQaagS.fn(v)}
 else {throw new Error(uErr0)}
 }
 ; return v}`, jitDependencies: ["fj_Fh5931", "fj_OQaagS"], pureFnDependencies: [], createJitFn: function get_fj_eeS8mQ(utl) {
    const uErr0 = "Can not json decode union: invalid union index";
    const fj_Fh5931 = utl.getJIT("fj_Fh5931");
    const fj_OQaagS = utl.getJIT("fj_OQaagS");
    return function fj_eeS8mQ(v) {
      if (v?.length === 2 && Array.isArray(v) && typeof v[0] === "number") {
        const dec0 = v[0];
        v = v[1];
        if (dec0 === 0) {
  ...
  }, fn: void 0 }, "sj_eeS8mQ": { isNoop: false, typeName: "union", fnID: "sj", jitFnHash: "sj_eeS8mQ", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not StringifyJson union: item does not belong to the union";
const is_Fh5931 = utl.getJIT("is_Fh5931");
const sj_Fh5931 = utl.getJIT("sj_Fh5931");
const tj_Fh5931 = utl.getJIT("tj_Fh5931");
const fj_Fh5931 = utl.getJIT("fj_Fh5931");
const is_OQaagS = utl.getJIT("is_OQaagS");
const sj_OQaagS = utl.getJIT("sj_OQaagS");
const tj_OQaagS = utl.getJIT("tj_OQaagS");
const fj_OQaagS = utl.getJIT("fj_OQaagS"); return function sj_eeS8mQ(v){if (typeof v === 'object' && v !== null && is_Fh5931.fn(v)) {return '[0,' + sj_Fh5931.fn(v) + ']'}else if (typeof v === 'object' && v !== null && is_OQaagS.fn(v)) {return '[1,' + sj_OQaagS.fn(v) + ']'}else {throw new Error(uErr0);}}`, jitDependencies: ["is_Fh5931", "sj_Fh5931", "tj_Fh5931", "fj_Fh5931", "is_OQaagS", "sj_OQaagS", "tj_OQaagS", "fj_OQaagS"], pureFnDependencies: [], createJitFn: function get_sj_eeS8mQ(utl) {
    const uErr0 = "Can not StringifyJson union: item does not belong to the union";
    const is_Fh5931 = utl.getJIT("is_Fh5931");
    const sj_Fh5931 = utl.getJIT("sj_Fh5931");
    utl.getJIT("tj_Fh5931");
    utl.getJIT("fj_Fh5931");
    const is_OQaagS = utl.getJIT("is_OQaagS");
    const sj_OQaagS = utl.getJIT("sj_OQaagS");
    utl.getJIT("tj_OQaagS");
    utl.getJIT("fj_OQaagS");
    return function sj_eeS8mQ(v) {
      if (typeof v === "object" && v !== null && is_Fh5931.fn(v)) {
        return "[0," + sj_Fh5931.fn(v) + "]";
      } else if (typeof v === "object" && v !== null && is_OQaagS.fn(v)) {
  ...
  }, fn: void 0 }, "sj_Fh5931": { isNoop: false, typeName: "SerializableMethodsData", fnID: "sj", jitFnHash: "sj_Fh5931", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_mkeGCe = utl.getJIT("sj_mkeGCe");
const sj_HnJJR1 = utl.getJIT("sj_HnJJR1");
const sj_cuUMAa = utl.getJIT("sj_cuUMAa"); return function sj_Fh5931(v){return '{'+'"purFnDeps":'+sj_mkeGCe.fn(v.purFnDeps)+","+'"methods":'+sj_HnJJR1.fn(v.methods)+","+'"deps":'+sj_cuUMAa.fn(v.deps)+'}'}`, jitDependencies: ["sj_mkeGCe", "sj_HnJJR1", "sj_cuUMAa"], pureFnDependencies: [], createJitFn: function get_sj_Fh5931(utl) {
    const sj_mkeGCe = utl.getJIT("sj_mkeGCe");
    const sj_HnJJR1 = utl.getJIT("sj_HnJJR1");
    const sj_cuUMAa = utl.getJIT("sj_cuUMAa");
    return function sj_Fh5931(v) {
      return '{"purFnDeps":' + sj_mkeGCe.fn(v.purFnDeps) + ',"methods":' + sj_HnJJR1.fn(v.methods) + ',"deps":' + sj_cuUMAa.fn(v.deps) + "}";
    };
...
const zT3pfXdp = utl.getPureFn("mion", "asJSONString"); return function sj_FX3Pr5(v){return (function(){const ns0 = [];ns0.push((function(){
 ...
 return ls1.join(',');
  ...
  }, fn: void 0 }, "sj_HnJJR1": { isNoop: false, typeName: "MethodsCache", fnID: "sj", jitFnHash: "sj_HnJJR1", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_qkOIac = utl.getJIT("sj_qkOIac");
const zT3pfXdp = utl.getPureFn("mion", "asJSONString"); return function sj_HnJJR1(v){return (function(){const ns0 = [];ns0.push((function(){
 const ls1 = [];
 for (const p1 in v) {
 
 if (p1 !== undefined) ls1.push(zT3pfXdp(p1) + ':' + sj_qkOIac.fn(v[p1]));
 }
 if (!ls1.length) return '';
 return ls1.join(',');
 })());return '{'+ns0.join(',')+'}'})()}`, jitDependencies: ["sj_qkOIac"], pureFnDependencies: ["mion::asJSONString"], createJitFn: function get_sj_HnJJR1(utl) {
    const sj_qkOIac = utl.getJIT("sj_qkOIac");
    const zT3pfXdp = utl.getPureFn("mion", "asJSONString");
    return function sj_HnJJR1(v) {
      return (function() {
        const ns0 = [];
        ns0.push((function() {
          const ls1 = [];
          for (const p1 in v) {
            if (p1 !== void 0) ls1.push(zT3pfXdp(p1) + ":" + sj_qkOIac.fn(v[p1]));
          }
          if (!ls1.length) return "";
          return ls1.join(",");
        })());
  ...
  }, fn: void 0 }, "sj_qkOIac": { isNoop: false, typeName: "MethodWithOptions", fnID: "sj", jitFnHash: "sj_qkOIac", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_Ei8qua = utl.getJIT("sj_Ei8qua");
const sj_s8eky2 = utl.getJIT("sj_s8eky2");
const sj_VJxRzx = utl.getJIT("sj_VJxRzx"); return function sj_qkOIac(v){return '{'+(v.paramNames === undefined ? '' : '"paramNames":'+sj_Ei8qua.fn(v.paramNames)+",")+(v.headersParam === undefined ? '' : '"headersParam":'+sj_s8eky2.fn(v.headersParam)+",")+(v.headersReturn === undefined ? '' : '"headersReturn":'+sj_s8eky2.fn(v.headersReturn)+",")+(v.middleFnIds === undefined ? '' : '"middleFnIds":'+sj_Ei8qua.fn(v.middleFnIds)+",")+'"type":'+v.type+","+'"id":'+JSON.stringify(v.id)+","+'"isAsync":'+(v.isAsync ? 'true' : 'false')+","+'"hasReturnData":'+(v.hasReturnData ? 'true' : 'false')+","+'"paramsJitHash":'+JSON.stringify(v.paramsJitHash)+","+'"returnJitHash":'+JSON.stringify(v.returnJitHash)+","+'"pointer":'+sj_Ei8qua.fn(v.pointer)+","+'"nestLevel":'+v.nestLevel+","+'"options":'+sj_VJxRzx.fn(v.options)+'}'}`, jitDependencies: ["sj_Ei8qua", "sj_s8eky2", "sj_VJxRzx"], pureFnDependencies: [], createJitFn: function get_sj_qkOIac(utl) {
    const sj_Ei8qua = utl.getJIT("sj_Ei8qua");
    const sj_s8eky2 = utl.getJIT("sj_s8eky2");
    const sj_VJxRzx = utl.getJIT("sj_VJxRzx");
    return function sj_qkOIac(v) {
...
const sj_WEWIGI = utl.getJIT("sj_WEWIGI"); return function sj_OQaagS(v){return '{'+(v.statusCode === undefined ? '' : '"statusCode":'+v.statusCode+",")+(v.id === undefined ? '' : '"id":'+(function(){if (Number.isFinite(v.id)) {return v.id}else if (typeof v.id === 'string') {return JSON.stringify(v.id)}else {throw new Error(uErr0);}})()+",")+(v.errorData === undefined ? '' : '"errorData":'+sj_WEWIGI.fn(v.errorData)+",")+"\\"mion@isΣrrθr\\""+':'+(v["mion@isΣrrθr"] ? 'true' : 'false')+","+'"type":'+JSON.stringify(v.type)+","+'"publicMessage":'+JSON.stringify(v.publicMessage)+'}'}`, jitDependencies: ["sj_WEWIGI"], pureFnDependencies: [], createJitFn: function get_sj_OQaagS(utl) {
  ...
  }, fn: void 0 }, "tBi_eeS8mQ": { isNoop: false, typeName: "union", fnID: "tBi", jitFnHash: "tBi_eeS8mQ", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not encode union to binary: item does not belong to the union";
const is_Fh5931 = utl.getJIT("is_Fh5931");
const tBi_Fh5931 = utl.getJIT("tBi_Fh5931");
const is_OQaagS = utl.getJIT("is_OQaagS");
const tBi_OQaagS = utl.getJIT("tBi_OQaagS"); return function tBi_eeS8mQ(v,Ser){if (typeof v === 'object' && v !== null && is_Fh5931.fn(v)) {Ser.view.setUint8(Ser.index++, 0);tBi_Fh5931.fn(v,Ser)}else if (typeof v === 'object' && v !== null && is_OQaagS.fn(v)) {Ser.view.setUint8(Ser.index++, 1);tBi_OQaagS.fn(v,Ser)}else {throw new Error(uErr0);} return Ser}`, jitDependencies: ["is_Fh5931", "tBi_Fh5931", "is_OQaagS", "tBi_OQaagS"], pureFnDependencies: [], createJitFn: function get_tBi_eeS8mQ(utl) {
    const uErr0 = "Can not encode union to binary: item does not belong to the union";
    const is_Fh5931 = utl.getJIT("is_Fh5931");
    const tBi_Fh5931 = utl.getJIT("tBi_Fh5931");
    const is_OQaagS = utl.getJIT("is_OQaagS");
    const tBi_OQaagS = utl.getJIT("tBi_OQaagS");
    return function tBi_eeS8mQ(v, Ser) {
      if (typeof v === "object" && v !== null && is_Fh5931.fn(v)) {
        Ser.view.setUint8(Ser.index++, 0);
        tBi_Fh5931.fn(v, Ser);
      } else if (typeof v === "object" && v !== null && is_OQaagS.fn(v)) {
  ...
  }, fn: void 0 }, "tBi_Fh5931": { isNoop: false, typeName: "SerializableMethodsData", fnID: "tBi", jitFnHash: "tBi_Fh5931", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_HnJJR1 = utl.getJIT("tBi_HnJJR1");
const tBi_cuUMAa = utl.getJIT("tBi_cuUMAa");
const tBi_mkeGCe = utl.getJIT("tBi_mkeGCe"); return function tBi_Fh5931(v,Ser){tBi_HnJJR1.fn(v.methods,Ser);tBi_cuUMAa.fn(v.deps,Ser);tBi_mkeGCe.fn(v.purFnDeps,Ser);
; return Ser}`, jitDependencies: ["tBi_HnJJR1", "tBi_cuUMAa", "tBi_mkeGCe"], pureFnDependencies: [], createJitFn: function get_tBi_Fh5931(utl) {
    const tBi_HnJJR1 = utl.getJIT("tBi_HnJJR1");
    const tBi_cuUMAa = utl.getJIT("tBi_cuUMAa");
    const tBi_mkeGCe = utl.getJIT("tBi_mkeGCe");
    return function tBi_Fh5931(v, Ser) {
      tBi_HnJJR1.fn(v.methods, Ser);
      tBi_cuUMAa.fn(v.deps, Ser);
      tBi_mkeGCe.fn(v.purFnDeps, Ser);
      return Ser;
    };
  }, fn: void 0 }, "tBi_HnJJR1": { isNoop: false, typeName: "MethodsCache", fnID: "tBi", jitFnHash: "tBi_HnJJR1", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_qkOIac = utl.getJIT("tBi_qkOIac"); return function tBi_HnJJR1(v,Ser){
 let cnt0 = 0; const piI0 = Ser.index; Ser.index += 4;
 for (const p0 in v) {Ser.serString(p0); tBi_qkOIac.fn(v[p0],Ser); cnt0++;}
 Ser.view.setUint32(piI0, cnt0, 1);
 ; return Ser}`, jitDependencies: ["tBi_qkOIac"], pureFnDependencies: [], createJitFn: function get_tBi_HnJJR1(utl) {
    const tBi_qkOIac = utl.getJIT("tBi_qkOIac");
    return function tBi_HnJJR1(v, Ser) {
      let cnt0 = 0;
      const piI0 = Ser.index;
      Ser.index += 4;
      for (const p0 in v) {
        Ser.serString(p0);
        tBi_qkOIac.fn(v[p0], Ser);
        cnt0++;
      }
      Ser.view.setUint32(piI0, cnt0, 1);
      return Ser;
    };
  }, fn: void 0 }, "tBi_qkOIac": { isNoop: false, typeName: "MethodWithOptions", fnID: "tBi", jitFnHash: "tBi_qkOIac", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_Ei8qua = utl.getJIT("tBi_Ei8qua");
const tBi_VJxRzx = utl.getJIT("tBi_VJxRzx");
const tBi_s8eky2 = utl.getJIT("tBi_s8eky2"); return function tBi_qkOIac(v,Ser){Ser.view.setFloat64(Ser.index,v.type, 1, (Ser.index += 8));Ser.serString(v.id);Ser.view.setUint8(Ser.index++, !!v.isAsync);Ser.view.setUint8(Ser.index++, !!v.hasReturnData);Ser.serString(v.paramsJitHash);Ser.serString(v.returnJitHash);tBi_Ei8qua.fn(v.pointer,Ser);Ser.view.setFloat64(Ser.index,v.nestLevel, 1, (Ser.index += 8));tBi_VJxRzx.fn(v.options,Ser);
const bmI0 = Ser.index; Ser.view.setUint8(Ser.index++, 0)
if (v.paramNames !== undefined) {tBi_Ei8qua.fn(v.paramNames,Ser);Ser.setBitMask(bmI0, 0 & 7)}if (v.headersParam !== undefined) {tBi_s8eky2.fn(v.headersParam,Ser);Ser.setBitMask(bmI0, 1 & 7)}if (v.headersReturn !== undefined) {tBi_s8eky2.fn(v.headersReturn,Ser);Ser.setBitMask(bmI0, 2 & 7)}if (v.middleFnIds !== undefined) {tBi_Ei8qua.fn(v.middleFnIds,Ser);Ser.setBitMask(bmI0, 3 & 7)} return Ser}`, jitDependencies: ["tBi_Ei8qua", "tBi_VJxRzx", "tBi_s8eky2"], pureFnDependencies: [], createJitFn: function get_tBi_qkOIac(utl) {
    const tBi_Ei8qua = utl.getJIT("tBi_Ei8qua");
    const tBi_VJxRzx = utl.getJIT("tBi_VJxRzx");
    const tBi_s8eky2 = utl.getJIT("tBi_s8eky2");
    return function tBi_qkOIac(v, Ser) {
  ...
  }, fn: void 0 }, "tBi_VJxRzx": { isNoop: false, typeName: "RemoteMethodOpts", fnID: "tBi", jitFnHash: "tBi_VJxRzx", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_hxdrPr = utl.getJIT("tBi_hxdrPr"); return function tBi_VJxRzx(v,Ser){
const bmI0 = Ser.index; Ser.view.setUint8(Ser.index++, 0)
...
if (v.id !== undefined) {if (Number.isFinite(v.id)) {Ser.view.setUint8(Ser.index++, 0);Ser.view.setFloat64(Ser.index,v.id, 1, (Ser.index += 8));}else if (typeof v.id === 'string') {Ser.view.setUint8(Ser.index++, 1);Ser.serString(v.id);}else {throw new Error(uErr1);};Ser.setBitMask(bmI0, 0 & 7)}if (v.errorData !== undefined) {tBi_WEWIGI.fn(v.errorData,Ser);Ser.setBitMask(bmI0, 1 & 7)}if (v.statusCode !== undefined) {Ser.view.setFloat64(Ser.index,v.statusCode, 1, (Ser.index += 8));Ser.setBitMask(bmI0, 2 & 7)} return Ser}`, jitDependencies: ["tBi_WEWIGI"], pureFnDependencies: [], createJitFn: function get_tBi_OQaagS(utl) {
  ...
  }, fn: void 0 }, "fBi_eeS8mQ": { isNoop: false, typeName: "union", fnID: "fBi", jitFnHash: "fBi_eeS8mQ", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index";
const fBi_Fh5931 = utl.getJIT("fBi_Fh5931");
const fBi_OQaagS = utl.getJIT("fBi_OQaagS"); return function fBi_eeS8mQ(ret,Des){
 const dec0 = Des.view.getUint8(Des.index++);
 if (dec0 === 0) {ret = fBi_Fh5931.fn(undefined,Des)}else if (dec0 === 1) {ret = fBi_OQaagS.fn(undefined,Des)}
 else {throw new Error(uErr0)}
 ; return ret}`, jitDependencies: ["fBi_Fh5931", "fBi_OQaagS"], pureFnDependencies: [], createJitFn: function get_fBi_eeS8mQ(utl) {
    const uErr0 = "Can not binary decode union: invalid union index";
    const fBi_Fh5931 = utl.getJIT("fBi_Fh5931");
    const fBi_OQaagS = utl.getJIT("fBi_OQaagS");
    return function fBi_eeS8mQ(ret, Des) {
      const dec0 = Des.view.getUint8(Des.index++);
      if (dec0 === 0) {
        ret = fBi_Fh5931.fn(void 0, Des);
      } else if (dec0 === 1) {
  ...
  }, fn: void 0 }, "fBi_Fh5931": { isNoop: false, typeName: "SerializableMethodsData", fnID: "fBi", jitFnHash: "fBi_Fh5931", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_HnJJR1 = utl.getJIT("fBi_HnJJR1");
const fBi_cuUMAa = utl.getJIT("fBi_cuUMAa");
const fBi_mkeGCe = utl.getJIT("fBi_mkeGCe"); return function fBi_Fh5931(ret,Des){return {methods:fBi_HnJJR1.fn(undefined,Des),deps:fBi_cuUMAa.fn(undefined,Des),purFnDeps:fBi_mkeGCe.fn(undefined,Des)}}`, jitDependencies: ["fBi_HnJJR1", "fBi_cuUMAa", "fBi_mkeGCe"], pureFnDependencies: [], createJitFn: function get_fBi_Fh5931(utl) {
    const fBi_HnJJR1 = utl.getJIT("fBi_HnJJR1");
    const fBi_cuUMAa = utl.getJIT("fBi_cuUMAa");
    const fBi_mkeGCe = utl.getJIT("fBi_mkeGCe");
    return function fBi_Fh5931(ret, Des) {
      return { methods: fBi_HnJJR1.fn(void 0, Des), deps: fBi_cuUMAa.fn(void 0, Des), purFnDeps: fBi_mkeGCe.fn(void 0, Des) };
    };
  }, fn: void 0 }, "fBi_HnJJR1": { isNoop: false, typeName: "MethodsCache", fnID: "fBi", jitFnHash: "fBi_HnJJR1", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_qkOIac = utl.getJIT("fBi_qkOIac"); return function fBi_HnJJR1(ret,Des){const cnt0 = Des.view.getUint32(Des.index, 1); Des.index += 4; ret = {}; for (let propI0 = 0; propI0 < cnt0; propI0++) {const p0 = Des.desSafePropName();ret[p0] = fBi_qkOIac.fn(undefined,Des);} return ret}`, jitDependencies: ["fBi_qkOIac"], pureFnDependencies: [], createJitFn: function get_fBi_HnJJR1(utl) {
    const fBi_qkOIac = utl.getJIT("fBi_qkOIac");
    return function fBi_HnJJR1(ret, Des) {
      const cnt0 = Des.view.getUint32(Des.index, 1);
      Des.index += 4;
      ret = {};
      for (let propI0 = 0; propI0 < cnt0; propI0++) {
        const p0 = Des.desSafePropName();
        ret[p0] = fBi_qkOIac.fn(void 0, Des);
      }
      return ret;
    };
  }, fn: void 0 }, "fBi_qkOIac": { isNoop: false, typeName: "MethodWithOptions", fnID: "fBi", jitFnHash: "fBi_qkOIac", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_Ei8qua = utl.getJIT("fBi_Ei8qua");
const fBi_VJxRzx = utl.getJIT("fBi_VJxRzx");
const fBi_s8eky2 = utl.getJIT("fBi_s8eky2"); return function fBi_qkOIac(ret,Des){ret = {type:Des.view.getFloat64(Des.index, 1, (Des.index += 8)),id:Des.desString(),isAsync:Des.view.getUint8(Des.index++) === 1,hasReturnData:Des.view.getUint8(Des.index++) === 1,paramsJitHash:Des.desString(),returnJitHash:Des.desString(),pointer:fBi_Ei8qua.fn(undefined,Des),nestLevel:Des.view.getFloat64(Des.index, 1, (Des.index += 8)),options:fBi_VJxRzx.fn(undefined,Des)}

const bimI0 = Des.index; Des.index += 1;
if (Des.view.getUint8(bimI0, 1) & (1 << (0 & 7))) {ret.paramNames = fBi_Ei8qua.fn(undefined,Des);}if (Des.view.getUint8(bimI0, 1) & (1 << (1 & 7))) {ret.headersParam = fBi_s8eky2.fn(undefined,Des);}if (Des.view.getUint8(bimI0, 1) & (1 << (2 & 7))) {ret.headersReturn = fBi_s8eky2.fn(undefined,Des);}if (Des.view.getUint8(bimI0, 1) & (1 << (3 & 7))) {ret.middleFnIds = fBi_Ei8qua.fn(undefined,Des);} return ret}`, jitDependencies: ["fBi_Ei8qua", "fBi_VJxRzx", "fBi_s8eky2"], pureFnDependencies: [], createJitFn: function get_fBi_qkOIac(utl) {
    const fBi_Ei8qua = utl.getJIT("fBi_Ei8qua");
    const fBi_VJxRzx = utl.getJIT("fBi_VJxRzx");
    const fBi_s8eky2 = utl.getJIT("fBi_s8eky2");
    return function fBi_qkOIac(ret, Des) {
  ...
  }, fn: void 0 }, "fBi_VJxRzx": { isNoop: false, typeName: "RemoteMethodOpts", fnID: "fBi", jitFnHash: "fBi_VJxRzx", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_hxdrPr = utl.getJIT("fBi_hxdrPr"); return function fBi_VJxRzx(ret,Des){ret = {}
...
if (Des.view.getUint8(tbimI0, 1) & (1 << (0))) {ret[0] = fBi_btp3Jb.fn(undefined,Des)} ; return ret}`, jitDependencies: ["fBi_btp3Jb"], pureFnDependencies: [], createJitFn: function get_fBi_gqqoWu(utl) {
 ...
 ; return er}`, jitDependencies: [], pureFnDependencies: ["mion::newRunTypeErr"], createJitFn: function get_te_MKk6Uk(utl) {
  ...
  exports.__ΩCloudflareSetupOptions = __ΩCloudflareSetupOptions;
  exports.resetServer = resetServer;
  exports.setup = setup;
  Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
})(this.CloudflareTestServer = this.CloudflareTestServer || {});
//# sourceMappingURL=test-server-cloudflare.js.map
