(function(exports) {
  ...
  function restoreCompiledJitFns(jitCache, pureCache, jUtil) {
    ...
    for (const namespace in pureCache) {
      ...
      keysPureFns.forEach(__assignType$b((key) => restoreCompiledPureFn(pureCache, namespace, key, jUtil, visitedPure), ["key", "", 'P"2!"/"']));
    }
    const keysJitFns = Object.keys(jitCache);
    keysJitFns.forEach(__assignType$b((key) => restoreCompiledJitFn(jitCache, pureCache, key, jUtil, visitedPure, visitedJit), ["key", "", 'P"2!"/"']));
  }
  ...
  function restoreCompiledPureFn(pureCache, namespace, fnName, jUtil, visited) {
    ...
    dependencies.forEach(__assignType$b((depName) => restoreCompiledPureFn(pureCache, namespace, depName, jUtil, visited), ["depName", "", 'P"2!"/"']));
  ...
  function restoreCompiledJitFn(jitCache, pureCache, fnHash, jUtil, visitedPure, visitedJit) {
    ...
    pureDependencies.forEach(__assignType$b((dep) => {
    ...
    dependencies.forEach(__assignType$b((dep) => restoreCompiledJitFn(jitCache, pureCache, dep, jUtil, visitedPure, visitedJit), ["dep", "", 'P"2!"/"']));
  ...
  const jitUtils = {
    ...
    hasJitFn: __assignType$a(function hasJitFn(jitFnHash) {
     ...
     *  */
    addPureFn: __assignType$a(function addPureFn(namespace, compiledFn) {
    ...
    usePureFn: __assignType$a(function usePureFn(namespace, fnHash) {
    ...
    getPureFn: __assignType$a(function getPureFn(namespace, fnHash) {
      const nsCache = pureFnsCache$1[namespace];
      if (!nsCache)
        return;
      const compiled = nsCache[fnHash];
    ...
    getCompiledPureFn: __assignType$a(function getCompiledPureFn(namespace, fnHash) {
      const nsCache = pureFnsCache$1[namespace];
      if (!nsCache)
        return;
      return nsCache[fnHash];
    }, ["namespace", "fnHash", () => __ΩCompiledPureFunction, "getCompiledPureFn", 'P&2!&2"Pn#-J/$']),
    hasPureFn: __assignType$a(function hasPureFn(namespace, fnHash) {
      const nsCache = pureFnsCache$1[namespace];
      if (!nsCache)
        return false;
      return !!nsCache[fnHash];
    }, ["namespace", "fnHash", "hasPureFn", 'P&2!&2")/#']),
    findCompiledPureFn: __assignType$a(function findCompiledPureFn(fnHash) {
    ...
    setSerializableClass: __assignType$a(function setSerializableClass(cls) {
    ...
    useSerializeClass: __assignType$a(function useSerializeClass(className) {
    ...
    getSerializeClass: __assignType$a(function getSerializeClass(className) {
      return serializableClassRegistry.get(className);
    }, ["className", "SerializableClass", "getSerializeClass", 'P&2!P"w"-J/#']),
    setDeserializeFn: __assignType$a(function setDeserializeFn(cls, deserializeFn) {
      const className = cls.name;
    ...
    useDeserializeFn: __assignType$a(function useDeserializeFn(className) {
      const fn = deserializeFnsRegistry.get(className);
      if (!fn)
    ...
    getDeserializeFn: __assignType$a(function getDeserializeFn(className) {
  ...
  const routesCache = {
     ...
     */
    getMetadata: __assignType$9(function getMetadata(id) {
     ...
     */
    setMetadata: __assignType$9(function setMetadata(id, methodData) {
     ...
     */
    hasMetadata: __assignType$9(function hasMetadata(id) {
     ...
     */
    getCache: __assignType$9(function getCache() {
      return methodsCache;
     ...
     */
    getMethodJitFns: __assignType$9(function getMethodJitFns(id) {
     ...
     * @returns
     */
    useMethodJitFns: __assignType$9(function useMethodJitFns(id) {
     ...
     */
    setMethodJitFns: __assignType$9(function setMethodJitFns(id, MethodWithOptsAndJitFns) {
      methodsCache[id] = MethodWithOptsAndJitFns;
    }, ["id", "MethodWithOptsAndJitFns", "setMethodJitFns", 'P&2!"w"2"$/#'])
  };
  ({
    getMethodOptions: __assignType$9(function getMethodOptions(id) {
      return methodsOptionsCache[id];
    }, ["id", "RemoteMethodOpts", "getMethodOptions", 'P&2!P"w"-J/#']),
    setMethodOptions: __assignType$9(function setMethodOptions(id, options2) {
...
Regenerate AOT caches using 'mion-build-aot' command.`);
  ...
  function getSerializableMethod(executable) {
    ...
    if (executable.type === HandlerType$1.route) {
      ...
      const pathPointers = getRouteExecutionChain(path)?.methods.filter(__assignType$7((exec) => isPublicExecutable(exec), ["exec", "", 'P"2!"/"'])).map(__assignType$7((exec) => exec.pointer, ["exec", "", 'P"2!"/"'])) || [];
      newRemoteMethod.middleFnIds = pathPointers.map(__assignType$7((pointer) => getRouterItemId(pointer), ["pointer", "", 'P"2!"/"'])).filter(__assignType$7((id) => {
  ...
  function mionGetRemoteMethodsDataById(ctx, methodsIds, getAllRemoteMethods) {
    ...
    const idsToReturn = shouldReturnAll ? getAllExecutablesIds().filter(__assignType$6((id) => !mionInternalRoutes.includes(id) && !isPrivateExecutable(getAnyExecutable(id)), ["id", "", 'P"2!"/"'])) : methodsIds;
  ...
  function mionGetRemoteMethodsDataByPath(ctx, path, getAllRemoteMethods) {
    ...
    const privateExecutables = executables.methods.filter(__assignType$6((e) => !isPrivateExecutable(e), ["e", "", 'P"2!"/"']));
    return mionGetRemoteMethodsDataById(ctx, privateExecutables.map(__assignType$6((e) => e.id, ["e", "", 'P"2!"/"'])), getAllRemoteMethods);
  }
  ...
  resetVercelHandlerOpts.__type = ["resetVercelHandlerOpts", 'P"/!'];
  ...
  setVercelHandlerOpts.__type = [() => __ΩPartial, "VercelHandlerOptions", "options", "setVercelHandlerOpts", 'P"w"o!"2#8"/$'];
  async function handleRequest(req) {
    ...
    try {
      const platformResp = await dispatchRoute(path, rawBody, req.headers, responseHeaders, req, void 0, reqBodyType, urlQuery);
  ...
  handleRequest.__type = ["req", "handleRequest", 'P!2!!`/"'];
  ...
  createVercelHandler.__type = ["createVercelHandler", 'P"/!'];
