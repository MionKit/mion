...
import type {EncoderOption, ResolvedEncoder, WireStrategy} from './types/general.types.ts';
...
export const WIRE_STRATEGIES = ['clone', 'mutate', 'direct', 'compact'] as const satisfies readonly WireStrategy[];
