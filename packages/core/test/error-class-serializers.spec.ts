...
import {RpcError, TypedError, FatalError, isFatalError} from '../src/errors.ts'; // side effect: registers the mion error-class serializers
import {HeadersSubset} from '../src/headers.ts'; // side effect: registers the HeadersSubset serializer
