...
import type {BooleanRunType} from '../runType/atomic/boolean';
import type {NullRunType} from '../runType/atomic/null';
import type {BigIntRunType} from '../runType/atomic/bigInt';
import type {AnyRunType} from '../runType/atomic/any';
import type {UndefinedRunType} from '../runType/atomic/undefined';
import type {UnknownRunType} from '../runType/atomic/unknown';
import type {VoidRunType} from '../runType/atomic/void';
import type {ArrayRunType} from '../runType/member/array';
import type {LiteralRunType} from '../runType/atomic/literal';
import type {RegexpRunType} from '../runType/atomic/regexp';
import type {NeverRunType} from '../runType/atomic/never';
import type {EnumRunType} from '../runType/atomic/enum';
import type {EnumMemberRunType} from '../runType/atomic/enumMember';
import type {UnionRunType} from '../runType/collection/union';
import type {TupleRunType} from '../runType/collection/tuple';
import type {TupleMemberRunType} from '../runType/member/tupleMember';
import type {InterfaceRunType, InterfaceMember} from '../runType/collection/interface';
...
import type {CallSignatureRunType} from '../runType/member/callSignature';
