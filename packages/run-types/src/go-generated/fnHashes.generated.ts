...
export const FN_HASHES = {
  ...
  parse: {axis: 'none', variants: {'': 'Twlw'}},
  parseFail: {axis: 'none', variants: {'': 'NoGk'}},
  parseStrip: {axis: 'none', variants: {'': 'Rn7j'}},
  prepareForJsonClone: {axis: 'none', variants: {'': 'A0Qb'}},
  prepareForJsonMutate: {axis: 'none', variants: {'': 'AwYs'}},
  restoreFromJson: {axis: 'none', variants: {'': 'd7YU'}},
  restoreFromJsonStrip: {axis: 'none', variants: {'': 'NWjz'}},
