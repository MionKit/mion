...
`new RegExp(` takes a build-time literal (GC-REGEXP), and no property access
spells a non-identifier name bare (GC-ACCESS). `generatedCodeOracle.unit.test.ts`
