...
export const STRING_FORMAT = {
  ...
  creditCard: {
    ...
    // `val` carries the failure MODE: the typo is a `checksum` failure (right
    // shape, digits do not add up), every other reject is a `format` one.
    expectedFormatErrors: () => [
      {name: 'creditCard', val: 'checksum'},
      {name: 'creditCard', val: 'format'},
      {name: 'creditCard', val: 'format'},
      {name: 'creditCard', val: 'format'},
      {name: 'creditCard', val: 'format'},
      {name: 'creditCard', val: 'format'},
  ...
  creditCard_network: {
    ...
    // A card from another network reports `networks`, carrying what the field
    // does take; a typo still reports the checksum.
    expectedFormatErrors: () => [
      {name: 'creditCard', val: ['visa'], formatPathTail: 'networks'},
      {name: 'creditCard', val: ['visa'], formatPathTail: 'networks'},
      {name: 'creditCard', val: 'checksum'},
      {name: 'creditCard', val: 'format'},
      null,
  ...
  creditCard_multiNetwork: {
    ...
    expectedFormatErrors: () => [
      {name: 'creditCard', val: ['visa', 'mastercard'], formatPathTail: 'networks'},
      {name: 'creditCard', val: ['visa', 'mastercard'], formatPathTail: 'networks'},
      {name: 'creditCard', val: 'format'},
      null,
    ],
