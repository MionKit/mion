...
export const UTILITY_TYPES = {
  awaited: {
    ...
    clone: () => createRemoveUnknownKeysFn<Awaited<Promise<{a: string; b: number; c: Date}>>>(),
  ...
  exclude_atomic: {
    ...
    clone: () => createRemoveUnknownKeysFn<Exclude<'name' | 'age' | number, 'age'>>(),
  ...
  required_properties: {
    ...
    clone: () => createRemoveUnknownKeysFn<Required<{name?: string; age?: number; createdAt?: Date}>>(),
    getTestData: () => ({
  ...
  extract_atomic: {
    ...
    clone: () => createRemoveUnknownKeysFn<Extract<'name' | 'age' | 'createdAt', 'name' | 'createdAt'>>(),
  ...
  partial_properties: {
    ...
    clone: () => createRemoveUnknownKeysFn<Partial<{name: string; age: number; createdAt: Date}>>(),
    getTestData: () => {
  ...
  pick_properties: {
    ...
    clone: () =>
      createRemoveUnknownKeysFn<Pick<{name: string; age: number; createdAt: Date; email: string}, 'name' | 'createdAt'>>(),
  ...
  omit_properties: {
    ...
    clone: () => createRemoveUnknownKeysFn<Omit<{name: string; age: number; createdAt: Date; email: string}, 'email'>>(),
  ...
  record_type: {
    ...
    clone: () => createRemoveUnknownKeysFn<Record<string, Date>>(),
    getTestData: () => ({
      values: [
        {
