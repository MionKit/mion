...
export const ARRAYS = {
  ...
  nullable_number_array: {
    ...
    clone: () => createRemoveUnknownKeysFn<(number | null)[]>(),
  ...
  array_circular: {
    ...
    clone: () => {
      ...
      return createRemoveUnknownKeysFn<CircularArray>();
    },
    getTestData: () => {
      type CircularArray = CircularArray[];
  ...
  objectElements: {
    ...
    clone: () => createRemoveUnknownKeysFn<Array<{a: string}>>(),
    getTestData: () => ({
      values: [
        [
          {a: 'x', extra: 1},
  ...
  readonly_array: {
    ...
    clone: () => createRemoveUnknownKeysFn<readonly string[]>(),
