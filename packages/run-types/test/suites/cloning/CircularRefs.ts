...
export const CIRCULAR_REFS = {
  circular_types: {
    ...
    clone: () => createRemoveUnknownKeysFn<CircularObject>(),
  ...
  circular_tuple: {
    ...
    clone: () => createRemoveUnknownKeysFn<CircularTuple>(),
    getTestData: () => ({
  ...
  circular_index: {
    ...
    clone: () => createRemoveUnknownKeysFn<CircularIndex>(),
    getTestData: () => ({
  ...
  circular_deep: {
    ...
    clone: () => createRemoveUnknownKeysFn<CircularDeep>(),
    getTestData: () => ({
  ...
  circular_tuple_complex: {
    ...
    clone: () => createRemoveUnknownKeysFn<CircularTupleComplex>(),
  ...
  object_with_circular_array: {
    ...
    clone: () => createRemoveUnknownKeysFn<ObjCircularArr>(),
    getTestData: () => ({
      values: [
