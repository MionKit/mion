...
import {createJsonDecoderFn, createJsonEncoderFn, type AnyOf} from '@mionjs/run-types';
...
export const UNIONS = {
  ...
  any_of_union: {
    ...
    description:
      'The AnyOf spelling IS the plain union: identical wire behavior, identical cached encoders, through every JSON strategy.',
