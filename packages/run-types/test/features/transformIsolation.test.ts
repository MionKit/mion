...
import {createValidateFn, createJsonDecoderFn, createJsonEncoderFn, createFormatTransformFn} from '@mionjs/run-types';
...
describe('transforms never run inside validate / decode / encode', () => {
  ...
  it('the JSON decoder and the JSON encoder round-trip the value untouched', () => {
