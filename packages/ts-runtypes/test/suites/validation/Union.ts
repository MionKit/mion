...
export const UNION = {
  ...
  string_literal_union: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({enum: ['UNO', 'DOS', 'TRES']})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({enum: ['UNO', 'DOS', 'TRES']})),
