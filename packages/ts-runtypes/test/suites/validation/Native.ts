...
export const NATIVE = {
  ...
  awaited_promise: {
    ...
    validateNotes: [
      ...
      'JSON Schema: unlike its NATIVE siblings this case IS spellable — the type resolves to plain `string`, so `{type: "string"}` spells it exactly and the runTypeFromJsonSchema form is filled.',
    ],
