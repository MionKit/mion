// validation / TypeMappings — per-variant it() blocks: every TYPE_MAPPINGS case
// yields up to 12 it()s (5 validate + 5 getValidationErrors + 2 mockType), each driven
// by its own helper in util/validationAsserts.ts. A missing thunk is signaled by
// the " (not implemented)" suffix in the it() title.
