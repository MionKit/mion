...
export const UTILITY = {
  ...
  exclude_atomic: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({enum: ['name', 'createdAt']})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({enum: ['name', 'createdAt']})),
  ...
  non_nullable: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({anyOf: [{type: 'string'}, {type: 'number'}]})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({anyOf: [{type: 'string'}, {type: 'number'}]})),
  ...
  omit_keeping_optional: {
    ...
    validateJsonSchema: () =>
      createValidateFn(jsonSchema({type: 'object', properties: {b: {type: 'number'}, c: {type: 'boolean'}}, required: ['c']})),
    ...
    getValidationErrorsJsonSchema: () =>
      createGetValidationErrorsFn(
        jsonSchema({type: 'object', properties: {b: {type: 'number'}, c: {type: 'boolean'}}, required: ['c']})
      ),
  ...
  keyof_to_literal_union: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({enum: ['name', 'age', 'createdAt']})),
    deserializeValidate: () => {
      interface Person {
        name: string;
        age: number;
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({enum: ['name', 'age', 'createdAt']})),
    deserializeGetValidationErrors: () => {
      interface Person {
        name: string;
        age: number;
  ...
  typeof_variable_query: {
    ...
    validateJsonSchema: () =>
      createValidateFn(
        jsonSchema({type: 'object', properties: {url: {type: 'string'}, port: {type: 'number'}}, required: ['url', 'port']})
      ),
    deserializeValidate: () => {
      const config = {url: 'http://example.com', port: 8080};
