// validation / Realworld — per-variant it() blocks: every REALWORLD case yields up
// to 12 it()s (5 validate + 5 getValidationErrors + 2 mockType), each driven by its
// own helper in util/validationAsserts.ts. A missing thunk is signaled by the
