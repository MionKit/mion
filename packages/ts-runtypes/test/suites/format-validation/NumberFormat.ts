...
export const NUMBER_FORMAT = {
  number_max: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'number', maximum: 100})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'number', maximum: 100})),
  ...
  number_min: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'number', minimum: 0})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'number', minimum: 0})),
  ...
  number_lt: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'number', exclusiveMaximum: 10})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'number', exclusiveMaximum: 10})),
  ...
  number_gt: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'number', exclusiveMinimum: 0})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'number', exclusiveMinimum: 0})),
  ...
  number_integer: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'integer'})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'integer'})),
  ...
  number_multipleOf: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'number', multipleOf: 5})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'number', multipleOf: 5})),
  ...
  number_combined: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'integer', minimum: 0, maximum: 100, multipleOf: 5})),
    ...
    getValidationErrorsJsonSchema: () =>
      createGetValidationErrorsFn(jsonSchema({type: 'integer', minimum: 0, maximum: 100, multipleOf: 5})),
  ...
  number_int8: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'integer', minimum: -128, maximum: 127})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'integer', minimum: -128, maximum: 127})),
  ...
  number_uint8: {
    ...
    validateJsonSchema: () => createValidateFn(jsonSchema({type: 'integer', minimum: 0, maximum: 255})),
    ...
    getValidationErrorsJsonSchema: () => createGetValidationErrorsFn(jsonSchema({type: 'integer', minimum: 0, maximum: 255})),
