// format-validation / StructuralFormat — the structural constraint
// keywords (formattedArray / formattedObject, contains / patternProperties /
// propertyNames) and the anyOf combinator, through the same per-variant
// it() matrix as StringFormat: 5 validate + 5 getValidationErrors forms
// (including the value-first schema contract) + 2 mockType forms per case.
