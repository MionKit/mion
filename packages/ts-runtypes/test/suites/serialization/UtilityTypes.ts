...
export const UTILITY_TYPES = {
  ...
  exclude_atomic: {
    ...
    jsonSchemaEncoder: () => createJsonEncoderFn(runTypeFromJsonSchema({anyOf: [{const: 'name'}, {type: 'number'}]})),
    jsonSchemaDecoder: () => createJsonDecoderFn(runTypeFromJsonSchema({anyOf: [{const: 'name'}, {type: 'number'}]})),
    jsonSchemaBinaryEncoder: () => createBinaryEncoderFn(runTypeFromJsonSchema({anyOf: [{const: 'name'}, {type: 'number'}]})),
    jsonSchemaBinaryDecoder: () => createBinaryDecoderFn(runTypeFromJsonSchema({anyOf: [{const: 'name'}, {type: 'number'}]})),
  ...
  extract_atomic: {
    ...
    jsonSchemaEncoder: () => createJsonEncoderFn(runTypeFromJsonSchema({enum: ['name', 'createdAt']})),
    jsonSchemaDecoder: () => createJsonDecoderFn(runTypeFromJsonSchema({enum: ['name', 'createdAt']})),
    jsonSchemaBinaryEncoder: () => createBinaryEncoderFn(runTypeFromJsonSchema({enum: ['name', 'createdAt']})),
    jsonSchemaBinaryDecoder: () => createBinaryDecoderFn(runTypeFromJsonSchema({enum: ['name', 'createdAt']})),
