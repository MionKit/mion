...
export const OBJECTS = {
  ...
  optional_properties_order: {
    ...
    jsonSchemaEncoder: () =>
      createJsonEncoderFn(
        runTypeFromJsonSchema({type: 'object', properties: {a: {type: 'string'}, b: {type: 'string'}}, required: ['a']})
      ),
    jsonSchemaDecoder: () =>
      createJsonDecoderFn(
        runTypeFromJsonSchema({type: 'object', properties: {a: {type: 'string'}, b: {type: 'string'}}, required: ['a']})
  ...
  all_optional_fields: {
    ...
    jsonSchemaEncoder: () =>
      createJsonEncoderFn(runTypeFromJsonSchema({type: 'object', properties: {a: {type: 'string'}, b: {type: 'string'}}})),
    jsonSchemaDecoder: () =>
      createJsonDecoderFn(runTypeFromJsonSchema({type: 'object', properties: {a: {type: 'string'}, b: {type: 'string'}}})),
    jsonSchemaBinaryEncoder: () =>
      createBinaryEncoderFn(runTypeFromJsonSchema({type: 'object', properties: {a: {type: 'string'}, b: {type: 'string'}}})),
    jsonSchemaBinaryDecoder: () =>
      createBinaryDecoderFn(runTypeFromJsonSchema({type: 'object', properties: {a: {type: 'string'}, b: {type: 'string'}}})),
    getTestData: () => ({values: [{a: 'helloA', b: 'helloB'}, {a: 'helloA'}, {}]}),
  },
