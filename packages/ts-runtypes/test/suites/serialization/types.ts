...
export interface SerializationCase {
  ...
  /** Opt a case out of the jsonSchema serializer id-integrity driver
   *  (`assertJsonSchemaSerializerIdIntegrity`): its jsonSchema-authored encoders
   ...
   *  literal via `jsonSchema({…})`), mirroring the four `schema*` thunks above:
