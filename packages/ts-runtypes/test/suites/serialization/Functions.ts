...
export const FUNCTIONS = {
  ...
  parameters: {
    ...
    schemaBinaryEncoder: () => createBinaryEncoderFn(RT.tuple({required: [TF.number(), RT.boolean(), TF.string()]})),
    schemaBinaryDecoder: () => createBinaryDecoderFn(RT.tuple({required: [TF.number(), RT.boolean(), TF.string()]})),
  ...
  optional_params: {
    ...
    schemaBinaryEncoder: () => createBinaryEncoderFn(RT.tuple({required: [TF.date()], optional: [RT.boolean()]})),
    schemaBinaryDecoder: () => createBinaryDecoderFn(RT.tuple({required: [TF.date()], optional: [RT.boolean()]})),
    jsonSchemaEncoder: 'not-supported',
    jsonSchemaDecoder: 'not-supported',
    jsonSchemaBinaryEncoder: 'not-supported',
    jsonSchemaBinaryDecoder: 'not-supported',
  ...
  function_with_rest_parameters: {
    ...
    schemaBinaryEncoder: () => createBinaryEncoderFn(RT.tuple({required: [TF.number(), RT.boolean()], rest: TF.date()})),
    schemaBinaryDecoder: () => createBinaryDecoderFn(RT.tuple({required: [TF.number(), RT.boolean()], rest: TF.date()})),
    jsonSchemaEncoder: 'not-supported',
    jsonSchemaDecoder: 'not-supported',
    jsonSchemaBinaryEncoder: 'not-supported',
    jsonSchemaBinaryDecoder: 'not-supported',
  ...
  function_with_only_rest_parameters: {
    ...
    serializeNotes:
      'JSON Schema: a rest-only Parameters tuple normalizes to plain number[], which {type: "array", items: {type: "number"}} spells exactly, so the runTypeFromJsonSchema thunks are filled.',
    mutateEncoder: () => {
    ...
    schemaBinaryEncoder: () => createBinaryEncoderFn(RT.tuple({rest: TF.number()})),
    schemaBinaryDecoder: () => createBinaryDecoderFn(RT.tuple({rest: TF.number()})),
    jsonSchemaEncoder: () => createJsonEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'number'}})),
    jsonSchemaDecoder: () => createJsonDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'number'}})),
    jsonSchemaBinaryEncoder: () => createBinaryEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'number'}})),
    jsonSchemaBinaryDecoder: () => createBinaryDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'number'}})),
  ...
  call_signature_params: {
    ...
    schemaBinaryEncoder: () => createBinaryEncoderFn(RT.tuple({required: [TF.number(), RT.boolean()]})),
    schemaBinaryDecoder: () => createBinaryDecoderFn(RT.tuple({required: [TF.number(), RT.boolean()]})),
    jsonSchemaEncoder: 'not-supported',
    jsonSchemaDecoder: 'not-supported',
    jsonSchemaBinaryEncoder: 'not-supported',
    jsonSchemaBinaryDecoder: 'not-supported',
  ...
  call_signature_return: {
    ...
    serializeNotes:
      'JSON Schema: ReturnType here resolves to plain string, which {type: "string"} spells exactly, so the runTypeFromJsonSchema thunks are filled.',
    ...
    jsonSchemaEncoder: () => createJsonEncoderFn(runTypeFromJsonSchema({type: 'string'})),
    jsonSchemaDecoder: () => createJsonDecoderFn(runTypeFromJsonSchema({type: 'string'})),
    jsonSchemaBinaryEncoder: () => createBinaryEncoderFn(runTypeFromJsonSchema({type: 'string'})),
    jsonSchemaBinaryDecoder: () => createBinaryDecoderFn(runTypeFromJsonSchema({type: 'string'})),
