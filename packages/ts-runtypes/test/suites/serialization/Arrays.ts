...
export const ARRAYS = {
  array: {
    ...
    jsonSchemaEncoder: () => createJsonEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'string'}})),
    jsonSchemaDecoder: () => createJsonDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'string'}})),
    jsonSchemaBinaryEncoder: () => createBinaryEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'string'}})),
    jsonSchemaBinaryDecoder: () => createBinaryDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'string'}})),
  ...
  null_in_array: {
    ...
    jsonSchemaEncoder: () => createJsonEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'null'}})),
    jsonSchemaDecoder: () => createJsonDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'null'}})),
    jsonSchemaBinaryEncoder: () => createBinaryEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'null'}})),
    jsonSchemaBinaryDecoder: () => createBinaryDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'null'}})),
  ...
  nullable_number_array: {
    ...
    jsonSchemaEncoder: () =>
      createJsonEncoderFn(runTypeFromJsonSchema({type: 'array', items: {anyOf: [{type: 'number'}, {type: 'null'}]}})),
    jsonSchemaDecoder: () =>
      createJsonDecoderFn(runTypeFromJsonSchema({type: 'array', items: {anyOf: [{type: 'number'}, {type: 'null'}]}})),
    jsonSchemaBinaryEncoder: () =>
      createBinaryEncoderFn(runTypeFromJsonSchema({type: 'array', items: {anyOf: [{type: 'number'}, {type: 'null'}]}})),
    jsonSchemaBinaryDecoder: () =>
      createBinaryDecoderFn(runTypeFromJsonSchema({type: 'array', items: {anyOf: [{type: 'number'}, {type: 'null'}]}})),
  ...
  multi_dimensional: {
    ...
    jsonSchemaEncoder: () =>
      createJsonEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'array', items: {type: 'string'}}})),
    jsonSchemaDecoder: () =>
      createJsonDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'array', items: {type: 'string'}}})),
    jsonSchemaBinaryEncoder: () =>
      createBinaryEncoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'array', items: {type: 'string'}}})),
    jsonSchemaBinaryDecoder: () =>
      createBinaryDecoderFn(runTypeFromJsonSchema({type: 'array', items: {type: 'array', items: {type: 'string'}}})),
  ...
  array_circular: {
    ...
    jsonSchemaEncoder: () => createJsonEncoderFn(runTypeFromJsonSchema({type: 'array', items: {$ref: '#'}})),
    jsonSchemaDecoder: () => createJsonDecoderFn(runTypeFromJsonSchema({type: 'array', items: {$ref: '#'}})),
    jsonSchemaBinaryEncoder: () => createBinaryEncoderFn(runTypeFromJsonSchema({type: 'array', items: {$ref: '#'}})),
    jsonSchemaBinaryDecoder: () => createBinaryDecoderFn(runTypeFromJsonSchema({type: 'array', items: {$ref: '#'}})),
    getTestData: () => {
      type CircularArray = CircularArray[];
