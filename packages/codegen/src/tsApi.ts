 ...
 *  I.e. type<PublicRoutes>.getText() returns:  import("/node_modules/@mion/packages/router/src/types").PublicRoutes<{}> | null
 *  The id part is:                             import("/node_modules/@mion/packages/router/src/types").PublicRoutes
 *  */
const getPublicRoutesTypeId = (options: CodegenOptions) => {
    ...
    const publicRoutesFileSample = `
        import {initRouter, registerRoutes} from '@mion/router';
        const myApp = {};
        const getShared = () => ({});
        const api = {};
    ...
    // this is expected to be something like: import("/node_modules/@mion/packages/router/src/types").PublicRoutes<{}> | null
...
export const getGenerateSpecJsCode = (options: CodegenOptions, exportedPublicRoutesNames: string[]): OutputFile => {
    ...
    const runAppAndGenerateSpec = `
        ...
        import {generateSpecFile} from '@mion/codegen';
