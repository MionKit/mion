...
it('validate multipleOf with 1', async () => {
    type MultipleOf1 = NumberFormat<{multipleOf: 1}>;
...
it('throws error when float is true but multipleOf is an integer', async () => {
    type InvalidType = NumberFormat<{float: true; multipleOf: 2}>;
