...
//
// The engine name is passed in by each caller (image.mjs reads MION_WEBSITE_ENGINE,
// bench.mjs reads MION_VALIDATION_BENCH_ENGINE), so this module is engine-agnostic and holds no
