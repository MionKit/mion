...
const ASSERT = process.env.MION_VALIDATION_BENCH_ENGINE_ASSERT === '1';
...
const MARGIN = Number(process.env.MION_VALIDATION_BENCH_ENGINE_MARGIN ?? 1.15);
...
if (!ASSERT) {
  ...
  console.log('engine-perf-check: set MION_VALIDATION_BENCH_ENGINE_ASSERT=1 once these numbers are trusted on this runner.');
  process.exit(0);
}
