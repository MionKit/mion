...
- Mind the build discipline: rebuild `bin/mion` after any Go edit before `pnpm test`, and rebuild `@mionjs/devtools` after any of its src edits (consumers read its dist). Details in [CLAUDE.md](../../../CLAUDE.md).
