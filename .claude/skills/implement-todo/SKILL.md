...
- Mind the build discipline: rebuild `bin/mion` after any Go edit before `pnpm test`, and rebuild `ts-runtypes-devtools` after any of its src edits (consumers read its dist). Details in [CLAUDE.md](../../../CLAUDE.md).
