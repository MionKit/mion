---
name: mion-setup
description: Bootstrap the host end to end, from podman, Node, pnpm and Go to the submodules, the resolver binary, the devtools dist and a smoke test of both containers. Use when setting up or verifying the environment.
---
