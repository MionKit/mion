...
var messagesByCode = map[string]message{
	...
	"MET003": {
		Headline: "The route id at this call is `string` (a generic helper erased it), so nothing can be bundled for it and the call fails at runtime under `bundleApi: 'bundled'`.",
