...
// row per registration, sorted by id.
var builtinEntries = []builtinEntry{
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#dateStrToMs",
		bodyHash:   "KYTuHdy_PdVu9V",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString",
		bodyHash:   "ep2XuKXlTAD6d5",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString_DM",
		bodyHash:   "-aL1AvZgpQ3LSv",
		paramNames: []string{"utl"},
		code:       "const isDate = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString');\n  return function _is_dm(value) {\n    const parts = value.split('-');\n    return parts.length === 2 && isDate(undefined, parts[1], parts[0]);\n  };",
		deps:       []string{"@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString"},
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString_DMY",
		bodyHash:   "DPysnGWrV5GdEm",
		paramNames: []string{"utl"},
		code:       "const isDate = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString');\n  return function _is_dmy(value) {\n    const parts = value.split('-');\n    return parts.length === 3 && isDate(parts[2], parts[1], parts[0]);\n  };",
		deps:       []string{"@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString"},
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString_MD",
		bodyHash:   "Ax_3P-6v42GDYH",
		paramNames: []string{"utl"},
		code:       "const isDate = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString');\n  return function _is_md(value) {\n    const parts = value.split('-');\n    return parts.length === 2 && isDate(undefined, parts[0], parts[1]);\n  };",
		deps:       []string{"@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString"},
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString_MDY",
		bodyHash:   "OTUNxlJ-fBqehv",
		paramNames: []string{"utl"},
		code:       "const isDate = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString');\n  return function _is_mdy(value) {\n    const parts = value.split('-');\n    return parts.length === 3 && isDate(parts[2], parts[0], parts[1]);\n  };",
		deps:       []string{"@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString"},
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString_YM",
		bodyHash:   "kUGHXudfV94TYJ",
		paramNames: []string{"utl"},
		code:       "const isDate = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString');\n  return function _is_ym(value) {\n    const parts = value.split('-');\n    return parts.length === 2 && isDate(parts[0], parts[1]);\n  };",
		deps:       []string{"@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString"},
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString_YMD",
		bodyHash:   "QEhicuYNAU7P7H",
		paramNames: []string{"utl"},
		code:       "const isDate = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString');\n  return function _is_ymd(value) {\n    const parts = value.split('-');\n    return parts.length === 3 && isDate(parts[0], parts[1], parts[2]);\n  };",
		deps:       []string{"@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isDateString"},
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isHours",
		bodyHash:   "LDZK6V5qqXunkc",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isMinutes",
		bodyHash:   "iAP62ZiVLSTvwV",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isSeconds",
		bodyHash:   "0vdSgtAIGyTIAZ",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isSecondsWithLeap",
		bodyHash:   "shzwEJoI8ui3pQ",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isSecondsWithMs",
		bodyHash:   "IpZydA2EKPfJDD",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isTimeString_HHmm",
		bodyHash:   "DwV4QV1sXcJh8Z",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isTimeString_HHmmss",
		bodyHash:   "YgJflB-67PWsBw",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isTimeString_ISO",
		bodyHash:   "ldCNyswWjK4NGT",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isTimeString_ISO_TZ",
		bodyHash:   "pac9addar9IIIv",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isTimeString_mmss",
		bodyHash:   "IwvMQTQyPXE1hd",
		paramNames: nil,
		code:       "function twoDigitsLE(s, at, max) {\n    const tens = s.charCodeAt(at) - 48;\n    const ones = s.charCodeAt(at + 1) - 48;\n    return tens >= 0 && tens <= 9 && ones >= 0 && ones <= 9 && tens * 10 + ones <= max;\n  }\n  return function _is_mmss(value) {\n    return value.length === 5 && value.charCodeAt(2) === 58 && twoDigitsLE(value, 0, 59) && twoDigitsLE(value, 3, 59);\n  };",
		deps:       nil,
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isTimeZone",
		bodyHash:   "LeGnSgRLHxZecA",
		paramNames: []string{"utl"},
		code:       "const isH = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isHours');\n  const isM = utl.getPureFn('@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isMinutes');\n  return function _is_tz(timeZone) {\n    if (timeZone === 'Z' || timeZone === 'z') return true;\n    const parts = timeZone.split(':');\n    return parts.length === 2 && isH(parts[0]) && isM(parts[1]);\n  };",
		deps:       []string{"@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isHours", "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#isMinutes"},
	},
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#relativeNowKey",
		bodyHash:   "1iExpFEAcs_Xww",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/datetime/dateTime-pure-fns#timeStrToMs",
		bodyHash:   "hKnryfEe5KHtuT",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/string/credit-card-pure-fns#cardNetworkRules",
		bodyHash:   "-QiIGpdO_Jm4tN",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/string/string-formats-pure-fns#isLocalHost",
		bodyHash:   "xNJl9jbrYp8zmC",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/string/string-formats-pure-fns#isUUID",
		bodyHash:   "l4RhwkePlYtfPW",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/string/string-formats-pure-fns#punycodeDecode",
		bodyHash:   "YHtue0yrYWKk44",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/string/string-formats-pure-fns#punycodeEncode",
		bodyHash:   "6xqC56iqnHahja",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/formats/string/string-formats-pure-fns#satisfiesBidi",
		bodyHash:   "kOBGIbk7p3I2kL",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/runtypes/circular-pure-fns#findCycle",
		bodyHash:   "pqxwqkEPvtEsTw",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/runtypes/pure-fns-utils#canonicalJson",
		bodyHash:   "LnET3T925Jjgdt",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/runtypes/pure-fns-utils#countEnumKeys",
		bodyHash:   "76owfaxrtelu6J",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/runtypes/pure-fns-utils#getUnknownKeysFromArray",
		bodyHash:   "Knj2u-LHtikvv6",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/runtypes/pure-fns-utils#hasUnknownKeysFromArray",
		bodyHash:   "vXv8KN6VDXSZXw",
		paramNames: nil,
	...
	{
		id:         "@mionjs/run-types/src/runtypes/pure-fns-utils#uniqueSetMembers",
		bodyHash:   "BbFNWPU8vstHBR",
		paramNames: []string{"utl"},
