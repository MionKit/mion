...
const pairedArraySource = `import {createValidateFn, getRunTypeId} from '@mionjs/run-types';
...
const namedAliasArraySource = `import {createValidateFn, getRunTypeId} from '@mionjs/run-types';
type Tags = string[];
