...
// four locale parameters applied to the ordinary friendly pipeline. Vars are
...
// halves ride nothing — WantMock is false. It is a disk-free twin of the CLI's
// cmd/ts-runtypes translationSpecs, kept here so the daemon needs no cmd import.
