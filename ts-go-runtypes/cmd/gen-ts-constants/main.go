...
func writeEntryModuleConstants(out *strings.Builder) {
	...
	out.WriteString("// The file every build writes into the bundler's output dir: the package's own pure fns, which a consumer's compiler serves from.\n")
	fmt.Fprintf(out, "export const PURE_FN_ARTIFACT_FILE = %q;\n", constants.PureFnArtifactFileName)
