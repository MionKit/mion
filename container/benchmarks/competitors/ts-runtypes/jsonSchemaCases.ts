...
// the `ts-go(jsonSchema)` form, which measures what recovering a type from a
// document costs the type checker.
//
// TOTAL over every shared key, and the supported set MIRRORS the ajv competitor
// map: ajv is the validation suite's JSON Schema reference, so a case ajv can
// state as a document is a case this column must answer, and a case it cannot
// (bigint, Date/RegExp/symbol, Map/Set/Promise, Temporal, circular refs, the
// advanced TS utility and template-literal types) is NOT_SUPPORTED here with the
// same reason. GENERATED from that map, then committed as source; the mirror is
// pinned by packages/ts-runtypes-devtools/test/bench-json-schema-cases.test.ts.
//
...
// runs on the draft-07 default export. The RunTypes door is 2020-12, where the
...
export const jsonSchemaCases: CompetitorCases = {
  // ── ATOMIC ──
  'ATOMIC.any': () => createValidateFn(runTypeFromJsonSchema({})),
  'ATOMIC.bigint': NOT_SUPPORTED, // no bigint type in JSON Schema
  'ATOMIC.boolean': () => createValidateFn(runTypeFromJsonSchema({type: 'boolean'})),
  'ATOMIC.date': NOT_SUPPORTED, // no Date instance type in JSON Schema
  'ATOMIC.enum_mixed': () => createValidateFn(runTypeFromJsonSchema({enum: [0, 'green', 2]})),
  'ATOMIC.literal_2': () => createValidateFn(runTypeFromJsonSchema({const: 2})),
  'ATOMIC.literal_a': () => createValidateFn(runTypeFromJsonSchema({const: 'a'})),
  'ATOMIC.literal_true': () => createValidateFn(runTypeFromJsonSchema({const: true})),
  ...
  'ATOMIC.never': () => createValidateFn(runTypeFromJsonSchema({not: {}})),
  'ATOMIC.null': () => createValidateFn(runTypeFromJsonSchema({type: 'null'})),
  'ATOMIC.number': () => createValidateFn(runTypeFromJsonSchema({type: 'number'})),
  ...
  'ATOMIC.string': () => createValidateFn(runTypeFromJsonSchema({type: 'string'})),
  ...
  'ATOMIC.literal_2_noLiterals': () => createValidateFn(runTypeFromJsonSchema({type: 'number'})),
  'ATOMIC.literal_a_noLiterals': () => createValidateFn(runTypeFromJsonSchema({type: 'string'})),
  'ATOMIC.literal_regexp_noLiterals': NOT_SUPPORTED, // degrades to RegExp; no RegExp instance type in JSON Schema
  'ATOMIC.literal_true_noLiterals': () => createValidateFn(runTypeFromJsonSchema({type: 'boolean'})),
  ...
  'ATOMIC.unknown': () => createValidateFn(runTypeFromJsonSchema({})),

  // ── ARRAY ──
  'ARRAY.string_array': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'string'}})),
  'ARRAY.number_array': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'number'}})),
  'ARRAY.boolean_array': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'boolean'}})),
  ...
  'ARRAY.null_array': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'null'}})),
  'ARRAY.array_generic': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'string'}})),
  'ARRAY.string_array_2d': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'array', items: {type: 'string'}}})),
  'ARRAY.string_array_3d': () => createValidateFn(runTypeFromJsonSchema({
        type: 'array',
  ...
  'ARRAY.object_array': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'object', properties: {a: {type: 'string'}}, required: ['a']}})),
  'ARRAY.union_array': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {anyOf: [{type: 'string'}, {type: 'number'}]}})),
  'ARRAY.tuple_array': () => createValidateFn(runTypeFromJsonSchema({
        type: 'array',
        items: {type: 'array', prefixItems: [{type: 'string'}, {type: 'number'}], items: false, minItems: 2},
      })),
  'ARRAY.circular_array': () => createValidateFn(runTypeFromJsonSchema({
        $id: 'circular_array',
        type: 'array',
        items: {$ref: 'circular_array'},
      })),
  'ARRAY.circular_object_with_array': () => createValidateFn(runTypeFromJsonSchema({
  ...
  'ARRAY.readonly_string_array': () => createValidateFn(runTypeFromJsonSchema({type: 'array', items: {type: 'string'}})),

  // ── OBJECT ──
  'OBJECT.simple_interface': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {a: {type: 'string'}, b: {type: 'number'}},
        required: ['a', 'b'],
      })),
  'OBJECT.object_as_const_literals': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {name: {const: 'john'}, age: {const: 30}},
        required: ['name', 'age'],
      })),
  'OBJECT.object_via_return_type_utility': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {id: {type: 'number'}, name: {type: 'string'}},
        required: ['id', 'name'],
      })),
  'OBJECT.object_via_property_access': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {id: {type: 'number'}, name: {type: 'string'}},
        required: ['id', 'name'],
      })),
  'OBJECT.object_via_array_access': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {id: {type: 'number'}, name: {type: 'string'}},
        required: ['id', 'name'],
      })),
  'OBJECT.interface_with_optional': () => createValidateFn(runTypeFromJsonSchema({type: 'object', properties: {a: {type: 'string'}, b: {type: 'number'}}, required: ['a']})),
  'OBJECT.interface_with_date': NOT_SUPPORTED, // no Date instance type in JSON Schema
  'OBJECT.interface_with_method': () => createValidateFn(runTypeFromJsonSchema({type: 'object', properties: {name: {type: 'string'}}, required: ['name']})),
  'OBJECT.nested_object': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          a: {type: 'string'},
  ...
  'OBJECT.interface_string_array_prop': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {tags: {type: 'array', items: {type: 'string'}}},
        required: ['tags'],
      })),
  'OBJECT.circular_interface': () => createValidateFn(runTypeFromJsonSchema({
  ...
  'OBJECT.circular_interface_on_array': () => createValidateFn(runTypeFromJsonSchema({
  ...
  'OBJECT.circular_interface_on_nested_object': () => createValidateFn(runTypeFromJsonSchema({
  ...
  'OBJECT.index_signature_string': () => createValidateFn(runTypeFromJsonSchema({type: 'object', additionalProperties: {type: 'string'}})),
  'OBJECT.index_signature_named_props': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          a: {type: 'string'},
          b: {type: 'number'},
  ...
  'OBJECT.index_signature_nested': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
  ...
  'OBJECT.index_signature_non_root': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          b: {type: 'string'},
          c: {
  ...
  'OBJECT.rpc_error_class': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
  ...
  'OBJECT.call_signature_params': () => createValidateFn(runTypeFromJsonSchema({type: 'array', prefixItems: [{type: 'number'}, {type: 'boolean'}], items: false, minItems: 2})),
  'OBJECT.call_signature_params_with_optional': () => createValidateFn(runTypeFromJsonSchema({
        type: 'array',
  ...
  'OBJECT.record_union_keys': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {a: {type: 'number'}, b: {type: 'number'}},
        required: ['a', 'b'],
      })),
  'OBJECT.union_value_index': NOT_SUPPORTED, // union includes bigint; no bigint type in JSON Schema
  'OBJECT.object_with_union_prop': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {kind: {enum: ['a', 'b']}, n: {type: 'number'}},
        required: ['kind', 'n'],
      })),
  'OBJECT.interface_inheritance': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {a: {type: 'string'}, b: {type: 'number'}},
        required: ['a', 'b'],
      })),
  'OBJECT.class_inheritance': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {a: {type: 'string'}, b: {type: 'number'}},
        required: ['a', 'b'],
      })),
  'OBJECT.index_signature_number_key': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        additionalProperties: {type: 'string'},
      })),

  // ── TUPLE ──
  'TUPLE.string_number_pair': () => createValidateFn(runTypeFromJsonSchema({type: 'array', prefixItems: [{type: 'string'}, {type: 'number'}], items: false, minItems: 2})),
  ...
  'TUPLE.nested_tuple_in_array': () => createValidateFn(runTypeFromJsonSchema({
        type: 'array',
        items: {type: 'array', prefixItems: [{type: 'string'}, {type: 'number'}], items: false, minItems: 2},
      })),
  'TUPLE.tuple_rest': () => createValidateFn(runTypeFromJsonSchema({type: 'array', prefixItems: [{type: 'number'}], items: {type: 'string'}, minItems: 1})),
  ...
  'TUPLE.tuple_named_labels': () => createValidateFn(runTypeFromJsonSchema({type: 'array', prefixItems: [{type: 'string'}, {type: 'number'}], items: false, minItems: 2})),
  'TUPLE.tuple_with_non_serializable': NOT_SUPPORTED, // function slot must be === undefined; no undefined type in JSON Schema
  'TUPLE.empty_tuple': () => createValidateFn(runTypeFromJsonSchema({type: 'array', maxItems: 0})),
  'TUPLE.single_element_tuple': () => createValidateFn(runTypeFromJsonSchema({type: 'array', prefixItems: [{type: 'string'}], items: false, minItems: 1})),
  'TUPLE.readonly_tuple': () => createValidateFn(runTypeFromJsonSchema({
        type: 'array',
  ...
  'UNION.string_literal_union': () => createValidateFn(runTypeFromJsonSchema({enum: ['UNO', 'DOS', 'TRES']})),
  'UNION.large_union_eight_arms': NOT_SUPPORTED, // arm contains bigint; no bigint type in JSON Schema
  'UNION.string_or_number': () => createValidateFn(runTypeFromJsonSchema({anyOf: [{type: 'string'}, {type: 'number'}]})),
  'UNION.union_of_array_types': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  'UNION.discriminated_union': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  'UNION.union_with_methods': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
          {type: 'object', properties: {name: {type: 'string'}}, required: ['name']},
          {type: 'object', properties: {age: {type: 'number'}}, required: ['age']},
        ],
      })),
  'UNION.intersection_to_object': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {a: {type: 'string'}, b: {type: 'number'}},
        required: ['a', 'b'],
      })),
  'UNION.union_with_index_arm': NOT_SUPPORTED, // arm c has bigint values; no bigint type in JSON Schema
  'UNION.union_same_prop_different_types': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  'UNION.union_merged_property': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  'UNION.union_with_any_fallback': () => createValidateFn(runTypeFromJsonSchema({})),
  'UNION.union_with_unknown_fallback': () => createValidateFn(runTypeFromJsonSchema({})),
  'UNION.union_subset_small_first': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
          {type: 'object', properties: {a: {type: 'string'}}, required: ['a']},
          {type: 'object', properties: {a: {type: 'string'}, b: {type: 'number'}}, required: ['a', 'b']},
        ],
      })),
  'UNION.union_subset_nested_levels': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  'UNION.union_subset_mixed_related_unrelated': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  // ── TEMPLATE_LITERAL ──
  'TEMPLATE_LITERAL.url_with_number_id': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^api\\/user\\/-?(?:\\d+\\.?\\d*|\\.\\d+)$',
      })),
  'TEMPLATE_LITERAL.multi_segment_url': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^\\/api\\/v\\d+\\/user\\/[\\s\\S]+\\/posts\\/-?(?:\\d+\\.?\\d*|\\.\\d+)$',
      })),
  'TEMPLATE_LITERAL.leading_string_placeholder': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^[\\s\\S]*\\/-?(?:\\d+\\.?\\d*|\\.\\d+)$',
      })),
  'TEMPLATE_LITERAL.regex_special_chars': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^\\(-?(?:\\d+\\.?\\d*|\\.\\d+)\\)$',
      })),
  'TEMPLATE_LITERAL.template_literal_nested_in_object': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
  ...
  'TEMPLATE_LITERAL.template_literal_index_key': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        patternProperties: {'^api\\/[\\s\\S]*$': {type: 'number'}},
        additionalProperties: false,
      })),
  'TEMPLATE_LITERAL.template_literal_union_placeholder': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^(?:a|b)--?(?:\\d+\\.?\\d*|\\.\\d+)$',
      })),
  ...
  'NATIVE.awaited_promise': () => createValidateFn(runTypeFromJsonSchema({type: 'string'})),
  ...
  'CIRCULAR.object_with_index_prop': () => createValidateFn(runTypeFromJsonSchema({
  ...
  'CIRCULAR.object_deeply_nested': () => createValidateFn(runTypeFromJsonSchema({
  ...
  'UTILITY.exclude_atomic': () => createValidateFn(runTypeFromJsonSchema({enum: ['name', 'createdAt']})),
  'UTILITY.extract_atomic': () => createValidateFn(runTypeFromJsonSchema({enum: ['name', 'createdAt']})),
  'UTILITY.exclude_from_object_union': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  'UTILITY.non_nullable': () => createValidateFn(runTypeFromJsonSchema({anyOf: [{type: 'string'}, {type: 'number'}]})),
  'UTILITY.return_type': NOT_SUPPORTED, // ReturnType resolves to Date; no Date instance type in JSON Schema
  'UTILITY.readonly': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
  ...
  'UTILITY.omit_keeping_optional': () => createValidateFn(runTypeFromJsonSchema({type: 'object', properties: {b: {type: 'number'}, c: {type: 'boolean'}}, required: ['c']})),
  'UTILITY.keyof_to_literal_union': () => createValidateFn(runTypeFromJsonSchema({enum: ['name', 'age', 'createdAt']})),
  'UTILITY.typeof_variable_query': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {url: {type: 'string'}, port: {type: 'number'}},
        required: ['url', 'port'],
      })),
  'UTILITY.indexed_access_type': () => createValidateFn(runTypeFromJsonSchema({type: 'string'})),
  'UTILITY.conditional_type_resolved': () => createValidateFn(runTypeFromJsonSchema({type: 'boolean'})),
  'UTILITY.mapped_type_custom': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          a: {type: ['string', 'null']},
          b: {type: ['number', 'null']},
  ...
  'UTILITY.mapped_type_with_conditional_value': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          name: {
            type: 'object',
  ...
  'UTILITY.distributive_conditional_over_union': () => createValidateFn(runTypeFromJsonSchema({
        anyOf: [
  ...
  // ── TYPE_MAPPINGS ──
  'TYPE_MAPPINGS.key_prefix_rename': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
  ...
  'TYPE_MAPPINGS.key_filter_via_never': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {id: {type: 'number'}, name: {type: 'string'}},
        required: ['id', 'name'],
      })),
  ...
  // ── STRING_FORMAT ──
  'STRING_FORMAT.string_maxLength': () => createValidateFn(runTypeFromJsonSchema({type: 'string', maxLength: 5})),
  'STRING_FORMAT.string_minLength': () => createValidateFn(runTypeFromJsonSchema({type: 'string', minLength: 3})),
  'STRING_FORMAT.string_length': () => createValidateFn(runTypeFromJsonSchema({type: 'string', minLength: 4, maxLength: 4})),
  'STRING_FORMAT.string_range': () => createValidateFn(runTypeFromJsonSchema({type: 'string', minLength: 2, maxLength: 4})),
  'STRING_FORMAT.string_allowedChars': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[0-9a-f]+$'})),
  ...
  'STRING_FORMAT.string_allowedChars_literal': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[.\\-]+$'})),
  'STRING_FORMAT.string_disallowedChars': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[^!@#]*$'})),
  'STRING_FORMAT.string_allowedValues': () => createValidateFn(runTypeFromJsonSchema({type: 'string', enum: ['red', 'green', 'blue']})),
  'STRING_FORMAT.string_allowedValues_ignoreCase': NOT_SUPPORTED, // case-insensitive enum match; no JSON Schema equivalent
  'STRING_FORMAT.string_allowedValues_escaped': () => createValidateFn(runTypeFromJsonSchema({type: 'string', enum: ['a.b', 'c+d']})),
  'STRING_FORMAT.string_disallowedValues': () => createValidateFn(runTypeFromJsonSchema({type: 'string', not: {enum: ['admin', 'root']}})),
  'STRING_FORMAT.string_customErrorMessage': () => createValidateFn(runTypeFromJsonSchema({type: 'string', enum: ['a', 'b']})),
  'STRING_FORMAT.alpha': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[A-Za-z]+$'})),
  'STRING_FORMAT.alphaNumeric': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[A-Za-z0-9]+$'})),
  'STRING_FORMAT.numeric': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[0-9]+$'})),
  'STRING_FORMAT.alpha_withLength': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[A-Za-z]+$', maxLength: 3})),
  'STRING_FORMAT.lowercase_validate': () => createValidateFn(runTypeFromJsonSchema({type: 'string'})),
  'STRING_FORMAT.uuidv4': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$',
      })),
  'STRING_FORMAT.uuidv7': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-7[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$',
      })),
  'STRING_FORMAT.date_iso': () => createValidateFn(runTypeFromJsonSchema({type: 'string', format: 'date'})),
  ...
  'STRING_FORMAT.date_YM': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^\\d{4}-(0[1-9]|1[0-2])$',
      })),
  'STRING_FORMAT.date_MD': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
  ...
  'STRING_FORMAT.time_iso': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^([01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d(?:\\.\\d+)?(?:Z|[+-](?:[01]\\d|2[0-3]):[0-5]\\d)$',
      })),
  'STRING_FORMAT.time_HHmmss': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^([01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d$',
      })),
  'STRING_FORMAT.time_HHmmss_ms': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
  ...
  'STRING_FORMAT.dateTime_default': () => createValidateFn(runTypeFromJsonSchema({type: 'string', format: 'date-time', pattern: 'T'})),
  'STRING_FORMAT.dateTime_custom': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
  ...
  'STRING_FORMAT.ipv4': () => createValidateFn(runTypeFromJsonSchema({type: 'string', format: 'ipv4'})),
  'STRING_FORMAT.ipv6': () => createValidateFn(runTypeFromJsonSchema({type: 'string', format: 'ipv6'})),
  'STRING_FORMAT.ip_any': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        anyOf: [
  ...
  'STRING_FORMAT.ipv4_port': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern:
          '^(?:(?:25[0-5]|2[0-4]\\d|1\\d{2}|[1-9]\\d|\\d)\\.){3}(?:25[0-5]|2[0-4]\\d|1\\d{2}|[1-9]\\d|\\d):(?:[1-9]\\d{0,3}|[1-5]\\d{4}|6[0-4]\\d{3}|65[0-4]\\d{2}|655[0-2]\\d|6553[0-5])$',
      })),
  'STRING_FORMAT.ipv6_port': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern:
  ...
  'STRING_FORMAT.domain': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\\.)+[a-zA-Z]{2,}$',
      })),
  'STRING_FORMAT.domainStrict': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\\.){1,5}[a-zA-Z]{2,}$',
      })),
  'STRING_FORMAT.email': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
  ...
  'STRING_FORMAT.emailPunycode': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern:
          '^[a-zA-Z0-9._%+\\-]{2,}@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\\.)*[a-zA-Z0-9]{2,}\\.(?:[a-zA-Z]{2,}|xn--[a-zA-Z0-9]+)$',
      })),
  'STRING_FORMAT.emailStrict': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
  ...
  'STRING_FORMAT.url': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^(?:https?|ftp|wss?):\\/\\/.+',
      })),
  'STRING_FORMAT.urlHttp': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^https?:\\/\\/.+',
      })),
  'STRING_FORMAT.urlFile': () => createValidateFn(runTypeFromJsonSchema({
        type: 'string',
        pattern: '^file:\\/\\/.+',
      })),
  'STRING_FORMAT.pattern_slug': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[a-z0-9]+(?:-[a-z0-9]+)*$'})),
  'STRING_FORMAT.pattern_hex': () => createValidateFn(runTypeFromJsonSchema({type: 'string', pattern: '^[0-9a-fA-F]+$'})),

  // ── NUMBER_FORMAT ──
  'NUMBER_FORMAT.number_max': () => createValidateFn(runTypeFromJsonSchema({type: 'number', maximum: 100})),
  'NUMBER_FORMAT.number_min': () => createValidateFn(runTypeFromJsonSchema({type: 'number', minimum: 0})),
  'NUMBER_FORMAT.number_lt': () => createValidateFn(runTypeFromJsonSchema({type: 'number', exclusiveMaximum: 10})),
  'NUMBER_FORMAT.number_gt': () => createValidateFn(runTypeFromJsonSchema({type: 'number', exclusiveMinimum: 0})),
  'NUMBER_FORMAT.number_integer': () => createValidateFn(runTypeFromJsonSchema({type: 'integer'})),
  'NUMBER_FORMAT.number_float': () => createValidateFn(runTypeFromJsonSchema({type: 'number', not: {type: 'integer'}})),
  'NUMBER_FORMAT.number_multipleOf': () => createValidateFn(runTypeFromJsonSchema({type: 'number', multipleOf: 5})),
  'NUMBER_FORMAT.number_combined': () => createValidateFn(runTypeFromJsonSchema({type: 'integer', minimum: 0, maximum: 100, multipleOf: 5})),
  'NUMBER_FORMAT.number_int8': () => createValidateFn(runTypeFromJsonSchema({type: 'integer', minimum: -128, maximum: 127})),
  'NUMBER_FORMAT.number_uint8': () => createValidateFn(runTypeFromJsonSchema({type: 'integer', minimum: 0, maximum: 255})),
  ...
  // ── REALWORLD ──
  'REALWORLD.user': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          id: {type: 'number'},
          email: {type: 'string'},
  ...
  'REALWORLD.order': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          id: {type: 'string'},
  ...
  'REALWORLD.blogPost': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          id: {type: 'number'},
          title: {type: 'string'},
  ...
  'REALWORLD.product': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          id: {type: 'string'},
          name: {type: 'string'},
  ...
  'REALWORLD.productPage': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          data: {
            type: 'array',
  ...
  'REALWORLD.registrationForm': () => createValidateFn(runTypeFromJsonSchema({
        type: 'object',
        properties: {
          email: {type: 'string'},
  ...
  'JSON_SCHEMA.pattern_properties': () => createValidateFn(runTypeFromJsonSchema({
        "type": "object",
        "patternProperties": {
          "^col_": {
            "type": "number"
  ...
  'JSON_SCHEMA.property_names': () => createValidateFn(runTypeFromJsonSchema({
        "type": "object",
        "propertyNames": {
          "pattern": "^[a-z]+$"
        },
  ...
  'JSON_SCHEMA.contains_count': () => createValidateFn(runTypeFromJsonSchema({
        "type": "array",
        "items": {
          "type": "number"
        },
  ...
  'JSON_SCHEMA.unique_items': () => createValidateFn(runTypeFromJsonSchema({
        "type": "array",
        "items": {
          "type": "number"
        },
  ...
  'JSON_SCHEMA.object_size': () => createValidateFn(runTypeFromJsonSchema({
        "type": "object",
        "additionalProperties": {
          "type": "number"
        },
  ...
  'JSON_SCHEMA.dependent_required': () => createValidateFn(runTypeFromJsonSchema({
        "type": "object",
        "properties": {
          "credit_card": {
            "type": "integer"
  ...
  'JSON_SCHEMA.string_email': () => createValidateFn(runTypeFromJsonSchema({
        "type": "string",
        "format": "email"
      })),
  'JSON_SCHEMA.int_bounded': () => createValidateFn(runTypeFromJsonSchema({
        "type": "integer",
        "minimum": 0,
        "maximum": 130
      })),
  'JSON_SCHEMA.string_pattern': () => createValidateFn(runTypeFromJsonSchema({
        "type": "string",
        "pattern": "^[a-z][a-z0-9-]*$"
      })),
  'JSON_SCHEMA.multiple_of': () => createValidateFn(runTypeFromJsonSchema({
        "type": "number",
        "multipleOf": 5
      })),
};
