...
// Decoys for src/tests/compile-output.spec.ts: a reflection marker and a pure function that
// belong to the CLIENT project and are never passed to inputFrom. The server's compile,
