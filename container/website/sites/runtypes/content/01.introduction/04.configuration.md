...
import runtypes from 'mion run-types/devtools/vite';
...
::note
Order `mion run-types/devtools` first among your `enforce: 'pre'` plugins, so it sees your source before other plugins rewrite it.
::
