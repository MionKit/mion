...
mion uses `@ts-runtypes/core` for automatic serialization.
...
<code-import path="packages/examples/src/router/serializer-modes.ts" lang="ts" commentStart="// start-json" commentEnd="// end-json" />
...
<code-import path="packages/examples/src/router/serializer-modes.ts" lang="ts" commentStart="// start-stringify-json" commentEnd="// end-stringify-json" />
...
<code-import path="packages/examples/src/router/serializer-modes.ts" lang="ts" commentStart="// start-binary" commentEnd="// end-binary" />
...
- **Optimized for numbers**: Using numeric type formats (`Int32`, `UInt8`, `Float`) enables fixed-size encodings
