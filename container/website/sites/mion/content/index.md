...
#body
  ...
  ---
    ...
    ---
    ### RunTypes <sup>©</sup>
    mion use [RunTypes](/run-types) behinds the scene to generate JIT-compiled validation and serialization functions directly from TypeScript types.
    RunTypes supports advanced [type formats](https://runtypes.pages.dev) and can be used as a standalone library.
