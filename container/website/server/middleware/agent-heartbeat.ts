...
// When the site runs in agent mode (MION_AGENT_HEARTBEAT set by `website.sh dev
...
// MION_AGENT_HEARTBEAT is unset (normal dev / production).
const heartbeatFile = process.env.MION_AGENT_HEARTBEAT
let lastTouch = 0
