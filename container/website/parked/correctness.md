...
::note
The full cross-library methodology and findings live in the [alignment report](https://github.com/MionKit/mion/blob/main/docs/cross-library-validation-alignment-report.md) in the repository.
::
