...
Middleware functions are defined using `middleFn` and can be executed before or after a route. middleware are functions that can be chained to create the full [Execution Chain](/rpc/server/middle-fns) for a route.
...
<!-- code-import-timestamp 1788541094357 -->
