...
#links
  ...
  color: primary
  size: xl
  to: /rpc/introduction/about-mion
...
#body
  ...
  ---
    ...
    ---
    ### RPC Like
    [RPC architecture](/rpc/introduction/about-mion#rpc-like) for simpler and easier to consume APIs.
    ...
    ---
    ### RunTypes <sup>©</sup>
    mion use [RunTypes](/rpc/run-types) behinds the scene to generate JIT-compiled validation and serialization functions directly from TypeScript types.
    ...
    ::::card
    ---
    to: /rpc/server/serialization#binary-serialization-in-detail
    class: sm:col-span-2 lg:col-span-1
    ---
