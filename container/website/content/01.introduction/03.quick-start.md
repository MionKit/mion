...
Vite is the shortest path, but the same plugin ships for Rollup, Rolldown, webpack, Rspack, esbuild and Bun. Each one has its own entry point, and every entry takes the same options.
