...
color: neutral
size: xl
to: /runtypes/introduction/about-ts-runtypes
...
[One spec, every framework →](/runtypes/guide/validation#standard-schema)
::::
:::
...
[Build-time, not run-time →](/runtypes/introduction/about-ts-runtypes#why-everything-happens-at-build-time)
::::
...
[Explore AI integration →](/runtypes/ai-integration/workflow-and-commands)
:::
::
