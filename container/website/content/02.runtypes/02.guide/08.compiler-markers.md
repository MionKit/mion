...
`getRTFunction` takes an injected handle and gives you back the callable function, without going through a factory. Pass it the same name you put in the marker.
