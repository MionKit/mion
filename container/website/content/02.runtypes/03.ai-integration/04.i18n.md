...
All the [placeholder tokens](/runtypes/ai-integration/friendly-type#message-placeholders) work exactly as they do in the source map, and a field that uses the [`rt$default` mode](/runtypes/ai-integration/friendly-type#one-message-per-field) has exactly one string to translate.
