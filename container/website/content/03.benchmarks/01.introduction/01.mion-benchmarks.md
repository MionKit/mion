...
#description
The fast is-valid check on the same types and payloads across the fastest validators. RunTypes also measures error reporting, JSON serialization, and what each type costs the compiler, all on their own pages.
