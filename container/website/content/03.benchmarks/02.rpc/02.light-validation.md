...
:server-bench-bars{bench="servers-light-validation" metric="requests" show-meta}

#### Throughput

:server-bench-bars{bench="servers-light-validation" metric="throughput"}

#### Latency

:server-bench-bars{bench="servers-light-validation" metric="latency"}

#### Max Memory

:server-bench-bars{bench="servers-light-validation" metric="maxMem"}

#### Max CPU

:server-bench-bars{bench="servers-light-validation" metric="maxCpu"}
