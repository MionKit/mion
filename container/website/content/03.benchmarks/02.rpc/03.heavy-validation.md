...
:bench-chart{bench="servers-heavy-validation" metric="throughput"}

#### Latency (ms)

:bench-chart{bench="servers-heavy-validation" metric="latency"}

#### Max Memory (MB)

:bench-chart{bench="servers-heavy-validation" metric="maxMem"}

#### Memory Series (MB)

:bench-chart{bench="servers-heavy-validation" metric="memSeries"}

## Results Table

:server-bench-table{bench="servers-heavy-validation"}
