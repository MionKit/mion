...
| --- | --- |
| **String** | `email`, `emailAddress`, `uuidv4`, `uuidv7`, `url`, `uri`, `ipv4`, `ipv6`, `domain`, `hostname`, `idnHostname`, `regexString`, `alpha`, `numeric`, `lowercase` |
