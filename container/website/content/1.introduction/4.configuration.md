...
| `strict` | `false` | When `true`, an incomplete or out-of-date translation fails `enrich --i18n --no-emit` instead of warning. Rendering at runtime stays lenient either way. |
