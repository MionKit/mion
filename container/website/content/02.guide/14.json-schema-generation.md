...
The formal version of the extension, one precise rule per keyword, lives in the repository at [json-schema-2020-12-javascript.md](https://github.com/MionKit/ts-run-types/blob/main/docs/json-schema-2020-12-javascript.md).
