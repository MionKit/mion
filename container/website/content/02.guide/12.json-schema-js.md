...
::note
The main goal of this extension is to store full JavaScript and TypeScript type information inside a JSON Schema. It is mainly used by the [type converter](/guide/source-conversion), which writes these keywords when it turns TypeScript files into schemas and reads them back when it converts in the other direction.
::
