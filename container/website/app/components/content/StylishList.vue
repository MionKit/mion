...
/* Check style: the checkmark in the site's brand colour. A data-URI SVG cannot
   read currentColor (it is its own document), so the icon is a MASK and the
   colour is the element's background. */
