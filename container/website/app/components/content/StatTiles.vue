...
// Big, colorful stat tiles for the homepage "Tested to the highest standard" block.
...
// tile spans the full row (horizontal layout); a `to` tile is a link, and an
// `action` tile carries a button instead (a link inside a linked tile would nest
// two anchors).
