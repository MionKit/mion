...
> are all DONE. See [04-progress-log.md](progress-log.md), [05-core-audit.md](core-audit.md),
> and [done/](./). The before/after mapping below remains an accurate description of the
